 ...
 * {@link #beforeAccess()} and {@link #afterAccess()} methods at appropriate points of its
 * workflow. Note that {@code afterAccess} should usually be called in a finally block!
 *
 * <p>
 * The default concurrency limit of this support class is -1 ("unbounded concurrency").
 * Subclasses may override this default; check the javadoc of the concrete class that
 * you're using.
 *
...
public abstract class ConcurrencyThrottleSupport implements Serializable {
	 ...
	 * <p>
	 * NOTE: Do not switch between -1 and any concrete limit at runtime, as this will lead
	 * to inconsistent concurrency counts: A limit of -1 effectively turns off concurrency
	 * counting completely.
	 */
