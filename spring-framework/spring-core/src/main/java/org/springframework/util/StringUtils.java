 ...
 * <a href="https://commons.apache.org/proper/commons-lang/">Apache's Commons Lang</a> for
...
public abstract class StringUtils {
	 ...
	 * effectively a shortcut for {@code !hasLength(String)}.
	 * <p>
	 ...
	 * @return the quoted {@code String} (e.g. "'myString'"), or {@code null} if the input
	 * was {@code null}
	 */
	@Nullable
	 ...
	 * <p>
	 * <strong>NOTE</strong> that {@code cleanPath} should not be depended upon in a
	 * security context. Other mechanisms should be used to prevent path-traversal issues.
	 ...
	 * @param enumeration the {@code Enumeration} to copy (potentially {@code null} or
	 * empty)
	 * @return the resulting {@code String} array
	 */
