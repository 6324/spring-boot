...
public class XmlValidationModeDetector {
	...
	/**
	 * Consume all leading and trailing comments in the given String and return the
	 * remaining content, which may be empty since the supplied content might be all
	 * comment data.
	 */
	@Nullable
