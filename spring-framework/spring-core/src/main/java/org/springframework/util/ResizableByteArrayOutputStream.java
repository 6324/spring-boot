 ...
 * {@link org.springframework.util.ResizableByteArrayOutputStream#resize(int)} methods to
 * get more control over the size of the internal buffer</li>
 * <li>has a higher initial capacity (256) by default</li>
 * </ul>
 *
 * <p>
 * As of 4.2, this class has been superseded by {@link FastByteArrayOutputStream} for
 * Spring's internal use where no assignability to {@link ByteArrayOutputStream} is needed
 * (since {@link FastByteArrayOutputStream} is more efficient with buffer resize
...
public class ResizableByteArrayOutputStream extends ByteArrayOutputStream {
	...
	/**
	 * Create a new <code>ResizableByteArrayOutputStream</code> with the default initial
	...
	/**
	 * Create a new <code>ResizableByteArrayOutputStream</code> with the specified initial
	 * capacity.
