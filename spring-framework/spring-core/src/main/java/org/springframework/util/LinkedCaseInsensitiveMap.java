 ...
 *
 * <p>
 * Preserves the original order as well as the original casing of keys, while allowing for
...
public class LinkedCaseInsensitiveMap<V> implements Map<String, V>, Serializable, Cloneable {
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that stores case-insensitive keys according
	 * to the default Locale (by default in lower case).
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that stores case-insensitive keys according
	 * to the given Locale (by default in lower case).
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with the
	 * given initial capacity and stores case-insensitive keys according to the default
	...
	/**
	 * Create a new LinkedCaseInsensitiveMap that wraps a {@link LinkedHashMap} with the
	 * given initial capacity and stores case-insensitive keys according to the given
	 * Locale (by default in lower case).
	 * @param initialCapacity the initial capacity
	 * @param locale the Locale to use for case-insensitive key conversion
	 * @see #convertKey(String)
	 ...
	 * <p>
	 * The default implementation converts the key to lower-case according to this Map's
	 * Locale.
