...
public interface Profiles {
	...
	/**
	 * Test if this {@code Profiles} instance <em>matches</em> against the given active
	 * profiles predicate.
	 * @param activeProfiles a predicate that tests whether a given profile is currently
	 * active
	 */
	 ...
	 * <p>
	 * As of Spring Framework 5.1.17, two {@code Profiles} instances returned by this
	 * method are considered equivalent to each other (in terms of {@code equals()} and
	 * {@code hashCode()} semantics) if they are created with identical <em>profile
	 * strings</em>.
