...
/**
 * Editor for {@link org.springframework.core.io.Resource} arrays, to automatically
 * convert {@code String} location patterns (e.g. {@code "file:C:/my*.txt"} or
 * {@code "classpath*:myfile.txt"}) to {@code Resource} array properties. Can also
 * translate a collection or array of location patterns into a merged Resource array.
 *
 * <p>
 * A path may contain {@code ${...}} placeholders, to be resolved as
 ...
 *
 * <p>
 * Delegates to a {@link ResourcePatternResolver}, by default using a
...
public class ResourceArrayPropertyEditor extends PropertyEditorSupport {
	 ...
	 * {@link ResourcePatternResolver} and {@link PropertyResolver} (typically an
	 * {@link Environment}).
