 ...
 *
 * <p>
 * Note that the {@link MergedAnnotations} model (which this interface has been designed
 * for) always ignores lang annotations according to the {@link #PLAIN} filter (for
 * efficiency reasons). Any additional filters and even custom filter implementations
 * apply within this boundary and may only narrow further from here.
 *
 * @author Phillip Webb
...
public interface AnnotationFilter {
	...
	/**
	 * {@link AnnotationFilter} that matches annotations in the {@code java.lang} and
	 * {@code org.springframework.lang} packages and their subpackages.
	 * <p>
	...
	/**
	 * {@link AnnotationFilter} that never matches and can be used when no filtering is
	 * needed (allowing for any annotation types to be present).
	 * @deprecated as of 5.2.6 since the {@link MergedAnnotations} model always ignores
	 * lang annotations according to the {@link #PLAIN} filter (for efficiency reasons)
	 * @see #PLAIN
	 */
	@Deprecated
	...
	/**
	 * Create a new {@link AnnotationFilter} that matches annotations in the specified
	 * packages.
