...
/**
 * Simple {@link Resource} implementation that holds a resource description but does not
 * point to an actually readable resource.
 *
 * <p>
 * To be used as placeholder if a {@code Resource} argument is expected by an API but not
