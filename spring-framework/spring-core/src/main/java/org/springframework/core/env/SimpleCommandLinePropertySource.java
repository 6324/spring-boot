 ...
 * by an equals sign ("="). The value may optionally be an empty string.
 *
 * <h4>Valid examples of option arguments</h4> <pre class="code">
 * --foo
 * --foo=
 * --foo=""
 * --foo=bar
 ...
 * --foo=bar,baz,biz</pre>
 *
 * <h4>Invalid examples of option arguments</h4> <pre class="code">
 * -foo
 * --foo bar
 * --foo = bar
 ...
 *
 * <h3>Typical usage</h3> <pre class="code">
 ...
 * {@link JOptCommandLinePropertySource}, or implement your own
...
public class SimpleCommandLinePropertySource extends CommandLinePropertySource<CommandLineArgs> {
	...
	/**
	 * Create a new {@code SimpleCommandLinePropertySource} having the default name and
	 * backed by the given {@code String[]} of command line arguments.
	...
	/**
	 * Create a new {@code SimpleCommandLinePropertySource} having the given name and
	 * backed by the given {@code String[]} of command line arguments.
	 */
