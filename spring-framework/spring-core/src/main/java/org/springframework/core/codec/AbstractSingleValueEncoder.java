...
/**
 * Abstract base class for {@link org.springframework.core.codec.Encoder} classes that can
...
public abstract class AbstractSingleValueEncoder<T> extends AbstractEncoder<T> {
	...
	public final Flux<DataBuffer> encode(Publisher<? extends T> inputStream, DataBufferFactory bufferFactory,
		...
		return Flux.from(inputStream).take(1)
	 ...
	 */
	protected abstract Flux<DataBuffer> encode(T t, DataBufferFactory dataBufferFactory, ResolvableType type,
