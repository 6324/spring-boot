...
public abstract class OrderUtils {
	...
	/**
	 * Return the order on the specified {@code type}, or the specified default value if
	 * none can be found.
	 * <p>
	...
	/**
	 * Return the value of the {@code javax.annotation.Priority} annotation declared on
	 * the specified type, or {@code null} if none.
	 * @param type the type to handle
