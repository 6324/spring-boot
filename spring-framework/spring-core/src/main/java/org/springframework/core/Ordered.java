 ...
 *
 * <p>
 * The actual {@link #getOrder() order} can be interpreted as prioritization, with the
 ...
 * {@link PriorityOrdered}. Consult the Javadoc for {@code PriorityOrdered} for details on
 * how {@code PriorityOrdered} objects are ordered relative to <em>plain</em>
