...
public interface DataBufferFactory {
	...
	/**
	 * Return a new {@code DataBuffer} composed of the {@code dataBuffers} elements joined
	 * together. Depending on the implementation, the returned buffer may be a single
	 * buffer containing all data of the provided buffers, or it may be a true composite
	 * that contains references to the buffers.
	 * <p>
	 * Note that the given data buffers do <strong>not</strong> have to be released, as
	 * they are released as part of the returned composite.
