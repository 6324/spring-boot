...
/**
 * {@code ClassLoader} that does <i>not</i> always delegate to the parent loader as normal
 * class loaders do. This enables, for example, instrumentation to be forced in the
 * overriding ClassLoader, or a "throwaway" class loading behavior where selected
 * application classes are temporarily loaded in the overriding {@code ClassLoader} for
 * introspection purposes before eventually loading an instrumented version of the class
 * in the given parent {@code ClassLoader}.
 *
 * @author Rod Johnson
...
public class OverridingClassLoader extends DecoratingClassLoader {
	...
	/**
	 * Determine whether the specified class is eligible for overriding by this class
	 * loader.
	 ...
	 * @param name the name of the class
	 * @return the byte content (with transformers already applied), or {@code null} if no
	 * class defined for that name
	 * @throws ClassNotFoundException if the class for the given name couldn't be loaded
	 */
	@Nullable
