...
/**
 * Holder that combines a {@link Resource} descriptor with a specific encoding or
 * {@code Charset} to be used for reading from the resource.
 *
 * <p>
 * Used as an argument for operations that support reading content with a specific
 * encoding, typically via a {@code java.io.Reader}.
 *
...
public class EncodedResource implements InputStreamSource {
	...
	/**
	 * Create a new {@code EncodedResource} for the given {@code Resource}, not specifying
	 * an explicit encoding or {@code Charset}.
	...
	/**
	 * Create a new {@code EncodedResource} for the given {@code Resource}, using the
	 * specified {@code encoding}.
	 * @param resource the {@code Resource} to hold (never {@code null})
	...
	/**
	 * Return the {@code Charset} to use for reading from the {@linkplain #getResource()
	 * resource}, or {@code null} if none specified.
	 */
	@Nullable
	 ...
	 * {@link InputStream}, i.e. whether an {@linkplain #getEncoding() encoding} or a
	 * {@link #getCharset() Charset} has been specified.
	 * @see #getReader()
	 * @see #getInputStream()
	 */
