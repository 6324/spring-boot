...
/**
 * Strategy for decoding a {@link DataBuffer} input stream into an output stream of
...
public interface Decoder<T> {
	...
	/**
	 * Whether the decoder supports the given target element type and the MIME type of the
	 * source stream.
	 * @param elementType the target element type for the output stream
	 * @param mimeType the mime type associated with the stream to decode (can be
	 ...
	 * @param elementType the expected type of elements in the output stream; this type
	 * must have been previously passed to the {@link #canDecode} method and it must have
	 * returned {@code true}.
	 * @param mimeType the MIME type associated with the input stream (optional)
	 * @param hints additional information about how to do encode
	 * @return the output stream with decoded elements
	 */
	Flux<T> decode(Publisher<DataBuffer> inputStream, ResolvableType elementType, @Nullable MimeType mimeType,
	 ...
	 * distinct messages (or events) are decoded and handled individually, in fully
	 * aggregated form.
	 ...
	 */
	@Nullable
	default T decode(DataBuffer buffer, ResolvableType targetType, @Nullable MimeType mimeType,
