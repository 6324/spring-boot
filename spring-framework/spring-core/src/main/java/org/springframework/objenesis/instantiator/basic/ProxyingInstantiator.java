...
/**
 * This instantiator creates a class by dynamically extending it. It will skip the call to
 * the parent constructor in the bytecode. So that the constructor is indeed not called
 * but you however instantiate a child class, not the actual class. The class loader will
 * normally throw a {@code VerifyError} is you do that. However, using
