...
/**
 * Use Objenesis in a static way. <strong>It is strongly not recommended to use this
 * class.</strong>
 *
...
public final class ObjenesisHelper {
	...
	/**
	 * Will create an object just like it's done by ObjectInputStream.readObject (the
	 * default constructor of the first non serializable class will be called)
	 * @param <T> Type instantiated
	 * @param clazz Class to instantiate
	 * @return New instance of clazz
	 */
	...
	/**
	 * Will pick the best instantiator for the provided class. If you need to create a lot
	 * of instances from the same class, it is way more efficient to create them from the
	 * same ObjectInstantiator than calling {@link #newInstance(Class)}.
