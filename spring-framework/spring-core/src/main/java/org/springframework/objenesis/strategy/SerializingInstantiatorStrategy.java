...
/**
 * Guess the best serializing instantiator for a given class. The returned instantiator
 * will instantiate classes like the genuine java serialization framework (the constructor
 * of the first not serializable class will be called). Currently, the selection doesn't
 * depend on the class. It relies on the
 * <ul>
 * <li>JVM version</li>
 * <li>JVM vendor</li>
