...
/**
 * Guess the best instantiator for a given class. The instantiator will instantiate the
 * class without calling any constructor. Currently, the selection doesn't depend on the
 * class. It relies on the
 * <ul>
 * <li>JVM version</li>
 * <li>JVM vendor</li>
...
public class StdInstantiatorStrategy extends BaseInstantiatorStrategy {
	...
	/**
	 * Return an {@link ObjectInstantiator} allowing to create instance without any
	...
	public <T> ObjectInstantiator<T> newInstantiatorOf(Class<T> type) {
		...
		if (PlatformDescription.isThisJVM(HOTSPOT) || PlatformDescription.isThisJVM(OPENJDK)) {
			...
			// The UnsafeFactoryInstantiator would also work. But according to benchmarks,
			// it is 2.5
