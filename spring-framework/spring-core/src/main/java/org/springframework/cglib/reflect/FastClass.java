...
abstract public class FastClass {
	...
	/**
	 * Return the index of the matching method. The index may be used later to invoke the
	 * method with less overhead. If more than one method matches (i.e. they differ by
	 * return type only), one is chosen arbitrarily.
	...
	/**
	 * Return the index of the matching constructor. The index may be used later to create
	 * a new instance with less overhead.
