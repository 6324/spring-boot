 ...
 * <code>Enhancer</code> interface or using reflection. In addition, to intercept methods
 * called during object construction you <b>must</b> use these methods instead of
 * reflection.
 *
...
public interface Factory {
	...
	/**
	 * Creates new instance of the same type, using the no-arg constructor. The class of
	 * this object must have been created using a single Callback type. If multiple
	 * callbacks are required an exception will be thrown.
	...
	/**
	 * Creates a new instance of the same type, using the constructor matching the given
	 * signature.
