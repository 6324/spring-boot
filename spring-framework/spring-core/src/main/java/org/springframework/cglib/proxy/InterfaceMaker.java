...
/**
 * Generates new interfaces at runtime. By passing a generated interface to the Enhancer's
 * list of interfaces to implement, you can make your enhanced classes handle an arbitrary
...
public class InterfaceMaker extends AbstractClassGenerator {
	...
	/**
	 * Create a new <code>InterfaceMaker</code>. A new <code>InterfaceMaker</code> object
	 * should be used for each generated interface, and should not be shared across
	 * threads.
	 */
	...
	/**
	 * Add a method signature to the interface. The method modifiers are ignored, since
	 * interface methods are by definition abstract and public.
	...
	/**
	 * Add all the public methods in the specified class. Methods from superclasses are
	 * included, except for methods declared in the base Object class (e.g.
	...
	public void generateClass(ClassVisitor v) throws Exception {
		...
		ce.begin_class(Constants.V1_8, Constants.ACC_PUBLIC | Constants.ACC_INTERFACE | Constants.ACC_ABSTRACT,
				getClassName(), null, null, Constants.SOURCE_FILE);
