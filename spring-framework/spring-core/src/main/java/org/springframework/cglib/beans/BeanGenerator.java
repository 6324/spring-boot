...
public class BeanGenerator extends AbstractClassGenerator {
	...
	/**
	 * Set the class which the generated class will extend. The class must not be declared
	 * as final, and must have a non-private no-argument constructor.
	...
	public void generateClass(ClassVisitor v) throws Exception {
		...
		ce.begin_class(Constants.V1_8, Constants.ACC_PUBLIC, getClassName(),
