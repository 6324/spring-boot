...
/**
 * <code>Mixin</code> allows multiple objects to be combined into a single larger object.
 * The methods in the generated object simply call the original methods in the underlying
 * "delegate" objects.
 *
...
abstract public class Mixin {
	...
	/**
	 * Helper method to create an interface mixin. For finer control over the generated
	 * instance, use a new instance of <code>Mixin</code> instead of this static method.
	 * TODO
	 */
