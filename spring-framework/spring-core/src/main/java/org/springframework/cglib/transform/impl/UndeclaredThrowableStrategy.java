 ...
 * causes all undeclared exceptions thrown from within a proxied method to be wrapped in
 * an alternative exception of your choice.
 */
public class UndeclaredThrowableStrategy extends DefaultGeneratorStrategy {
	 ...
	 * <code>Throwable</code> and which has at least one constructor that takes a single
	 * argument of type <code>Throwable</code>, for example
