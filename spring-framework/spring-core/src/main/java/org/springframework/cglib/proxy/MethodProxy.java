 ...
 * {@link MethodInterceptor} objects when an intercepted method is invoked. It can be used
 * to either invoke the original method, or call the same method on a different object of
 * the same type.
 *
...
public class MethodProxy {
	 ...
	 * {@link org.springframework.cglib.reflect.FastMethod} class for similar
	 * functionality.
	 */
	 ...
	 * {@link #invokeSuper}. This index uniquely identifies the method within the
	 * generated proxy, and therefore can be useful to reference external metadata.
	 * @see #getSuperName
	 */
	...
	/**
	 * Return the <code>MethodProxy</code> used when intercepting the method matching the
	 * given signature.
	 ...
	 * @throws IllegalArgumentException if the Class was not created by Enhancer or does
	 ...
	 * passed as the first argument to the MethodInterceptor (usually not what you want)
	 * @param args the arguments passed to the intercepted method; you may substitute a
	 * different argument array as long as the types are compatible
	 * @throws Throwable the bare exceptions thrown by the called method are passed
	 * through without wrapping in an <code>InvocationTargetException</code>
	 ...
	 * @param obj the enhanced object, must be the object passed as the first argument to
