...
abstract public class StringSwitcher {
	...
	/**
	 * Helper method to create a StringSwitcher. For finer control over the generated
	 * instance, use a new instance of StringSwitcher.Generator instead of this static
	 * method.
	 ...
	 * as <code>-1</code>; if true, the result will be undefined, and the resulting code
	 * will be faster
	 */
	 ...
	 * @param s the key
	 * @return the associated integer value, or <code>-1</code> if the key is unknown
	 * (unless <code>fixedInput</code> was specified when this <code>StringSwitcher</code>
	...
	public static class Generator extends AbstractClassGenerator {
		 ...
		 * @param fixedInput if false, an unknown key will be returned from
		 * {@link #intValue} as <code>-1</code>; if true, the result will be undefined,
		 * and the resulting code will be faster
		 */
		...
		public void generateClass(ClassVisitor v) throws Exception {
			...
			ce.begin_class(Constants.V1_8, Constants.ACC_PUBLIC, getClassName(), STRING_SWITCHER, null,
