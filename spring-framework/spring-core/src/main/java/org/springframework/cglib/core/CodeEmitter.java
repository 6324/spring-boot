...
public class CodeEmitter extends LocalVariablesSorter {
	...
	/**
	 * If the argument is a primitive class, replaces the primitive value on the top of
	 * the stack with the wrapped (Object) equivalent. For example, char -> Character. If
	 * the class is Void, a null is pushed onto the stack instead.
	...
	/**
	 * If the argument is a primitive class, replaces the object on the top of the stack
	 * with the unwrapped (primitive) equivalent. For example, Character -> char.
	 ...
	 * Primitive values are inserted as their boxed (Object) equivalents.
	 */
	...
	/**
	 * Unboxes the object on the top of the stack. If the object is null, the unboxed
	 * primitive value becomes zero.
	 */
