 ...
 *
 * <p>
 * Use {@code @NonNullApi} (scope = parameters + return values) and/or
 * {@code @NonNullFields} (scope = fields) to set the default behavior to non-nullable in
 * order to avoid annotating your whole codebase with {@code @NonNull}.
 *
