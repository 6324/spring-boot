...
public abstract class ResourceTestUtils {
	...
	/**
	 * Load a {@link ClassPathResource} qualified by the simple name of clazz, and
	 * relative to the package for clazz.
	 * <p>
	 * Example: given a clazz 'com.foo.BarTests' and a resourceSuffix of 'context.xml',
	 * this method will return a ClassPathResource representing
	 * com/foo/BarTests-context.xml
	 * <p>
