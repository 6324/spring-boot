...
/**
 * Simple {@link PropertySource} implementation for use in testing. Accepts a
 * user-provided {@link Properties} object, or if omitted during construction, the
 * implementation will initialize its own.
 *
...
public class MockPropertySource extends PropertiesPropertySource {
	...
	/**
	 * {@value} is the default name for {@link MockPropertySource} instances not otherwise
	...
	/**
	 * Create a new {@code MockPropertySource} named
	 * {@value #MOCK_PROPERTIES_PROPERTY_SOURCE_NAME} that will maintain its own internal
	...
	/**
	 * Create a new {@code MockPropertySource} with the given name that will maintain its
	 * own internal {@link Properties} instance.
	...
	/**
	 * Create a new {@code MockPropertySource} named
	 * {@value #MOCK_PROPERTIES_PROPERTY_SOURCE_NAME} and backed by the given
