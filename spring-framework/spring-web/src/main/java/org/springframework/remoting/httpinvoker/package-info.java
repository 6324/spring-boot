/**
 * Remoting classes for transparent Java-to-Java remoting via HTTP invokers. Uses Java
 * serialization just like RMI, but provides the same ease of setup as Caucho's HTTP-based
 * Hessian protocol.
 *
 * <p>
