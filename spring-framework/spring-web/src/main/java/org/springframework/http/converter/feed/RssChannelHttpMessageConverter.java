 ...
 * can read and write RSS feeds. Specifically, this converter can handle {@link Channel}
 ...
 *
 * <p>
 * By default, this converter reads and writes the media type
 * ({@code application/rss+xml}). This can be overridden through the
