...
/**
 * Extension of {@link CodecConfigurer} for HTTP message reader and writer options
 * relevant on the server side.
 *
 * <p>
 ...
 * <li>{@link String}
 * <li>{@link org.springframework.util.MultiValueMap MultiValueMap&lt;String,String&gt;}
 * for form data
 * <li>{@link org.springframework.util.MultiValueMap MultiValueMap&lt;String,Object&gt;}
 * for multipart data
...
public interface ServerCodecConfigurer extends CodecConfigurer {
	 ...
	 * {@inheritDoc}
	 * <p>
	 * On the server side, built-in default also include customizations related to the
	 * encoder for SSE.
	 */
	@Override
	...
	interface ServerDefaultCodecs extends DefaultCodecs {
		 ...
		 * <p>
		 * By default, if
		 * <a href="https://github.com/synchronoss/nio-multipart">Synchronoss NIO
		 * Multipart</a> is present, this is set to
		 ...
		 * {@link #enableLoggingRequestDetails(boolean)}, if configured, will be applied
		 * to the given reader, if applicable.
		 ...
		 * {@link #jackson2JsonEncoder} override is used instead. Use this method to
		 * customize the SSE encoder.
		 */
