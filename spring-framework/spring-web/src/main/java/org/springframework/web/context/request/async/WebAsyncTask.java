...
public class WebAsyncTask<V> implements BeanFactoryAware {
	...
	/**
	 * Create a {@code WebAsyncTask} with a timeout value, an executor name, and a
	 * {@link Callable}.
	...
	/**
	 * Create a {@code WebAsyncTask} with a timeout value, an executor instance, and a
	 * Callable.
	 * @param timeout the timeout value in milliseconds; ignored if {@code null}
	 ...
	 * <p>
	 * This factory reference will automatically be set when {@code WebAsyncTask} is used
	 * within a Spring MVC controller.
	 */
	@Override
	...
	/**
	 * Return the AsyncTaskExecutor to use for concurrent handling, or {@code null} if
	 * none specified.
	 */
	@Nullable
	 ...
	 * before the {@code Callable} has completed. The callback is executed in the same
	 * thread and therefore should return without blocking. It may return an alternative
	 * value to use, including an {@link Exception} or return
	 ...
	 * <p>
	 * This method is called from a container thread when an error occurred while
	 * processing an async request before the {@code Callable} has completed. The callback
	 * is executed in the same thread and therefore should return without blocking. It may
	 * return an alternative value to use, including an {@link Exception} or return
	 * {@link CallableProcessingInterceptor#RESULT_NONE RESULT_NONE}.
	 * @since 5.0
	 */
	 ...
	 * any reason, including timeout and network error.
	 */
