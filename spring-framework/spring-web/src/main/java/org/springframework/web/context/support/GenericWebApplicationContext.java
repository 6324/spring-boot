 ...
 *
 * <p>
 * <b>If you intend to implement a WebApplicationContext that reads bean definitions from
 * configuration files, consider deriving from AbstractRefreshableWebApplicationContext,
 ...
 * accessed via "file:" URLs, as implemented by AbstractApplicationContext.
 *
 * <p>
 ...
 * detects a ThemeSource bean in the context, with the name "themeSource".
 *
...
public class GenericWebApplicationContext extends GenericApplicationContext
	...
	/**
	 * Create a new GenericWebApplicationContext with the given
	...
	public Class<?> getType(String name, boolean allowFactoryBeanInit) throws NoSuchBeanDefinitionException {
		System.out.println("调试getType" + this.getClass().getPackage());
		return null;
	}
