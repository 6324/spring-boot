...
public interface ConfigurableWebEnvironment extends ConfigurableEnvironment {
	...
	/**
	 * Replace any
	 * {@linkplain org.springframework.core.env.PropertySource.StubPropertySource stub
	 * property source} instances acting as placeholders with real servlet context/config
	 * property sources using the given parameters.
