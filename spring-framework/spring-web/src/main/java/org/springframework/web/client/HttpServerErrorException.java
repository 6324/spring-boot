...
public class HttpServerErrorException extends HttpStatusCodeException {
	...
	/**
	 * Constructor with a status code and status text, headers, content, and an prepared
	 * message.
	 * @since 5.2.2
	 */
	 ...
	 * @since 5.1
	 */
	public static HttpServerErrorException create(HttpStatus statusCode, String statusText, HttpHeaders headers,
	...
	/**
	 * Variant of
	 * {@link #create(String, HttpStatus, String, HttpHeaders, byte[], Charset)} with an
	 * optional prepared message.
	 * @since 5.2.2.
	 */
	...
	public static final class NotImplemented extends HttpServerErrorException {
		...
		private NotImplemented(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class BadGateway extends HttpServerErrorException {
		...
		private BadGateway(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class GatewayTimeout extends HttpServerErrorException {
		...
		private GatewayTimeout(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
