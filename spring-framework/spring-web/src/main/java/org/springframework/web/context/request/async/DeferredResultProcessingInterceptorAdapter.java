...
/**
 * Abstract adapter class for the {@link DeferredResultProcessingInterceptor} interface
...
public abstract class DeferredResultProcessingInterceptorAdapter implements DeferredResultProcessingInterceptor {
	...
	/**
	 * This implementation returns {@code true} by default allowing other interceptors to
	 * be given a chance to handle the timeout.
	 */
	@Override
	...
	/**
	 * This implementation returns {@code true} by default allowing other interceptors to
	 * be given a chance to handle the error.
	 */
	@Override
