 ...
 * {@link #EXCHANGE_CONTEXT_ATTRIBUTE}. This is useful for access to the exchange without
 * explicitly passing it to components that participate in request processing.
 *
 * <p>
...
public class ServerWebExchangeContextFilter implements WebFilter {
	...
	/**
	 * Access the {@link ServerWebExchange} from the Reactor Context, if available, which
	 * is if {@link ServerWebExchangeContextFilter} is configured for use and the give
	 * context was obtained from a request processing chain.
