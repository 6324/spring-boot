 ...
 * {@link org.springframework.http.HttpHeaders HttpHeaders} then the map is populated with
...
public @interface RequestHeader {
	 ...
	 * <p>
	 * Defaults to {@code true}, leading to an exception being thrown if the header is
