...
public class HttpClientErrorException extends HttpStatusCodeException {
	 ...
	 */
	public HttpClientErrorException(HttpStatus statusCode, String statusText, @Nullable HttpHeaders headers,
	...
	/**
	 * Constructor with a status code and status text, headers, and content, and an
	 * prepared message.
	 * @since 5.2.2
	 */
	 ...
	 * @since 5.1
	 */
	public static HttpClientErrorException create(HttpStatus statusCode, String statusText, HttpHeaders headers,
	...
	/**
	 * Variant of {@link #create(HttpStatus, String, HttpHeaders, byte[], Charset)} with
	 * an optional prepared message.
	 * @since 5.2.2
	 */
	public static HttpClientErrorException create(@Nullable String message, HttpStatus statusCode, String statusText,
		...
		case FORBIDDEN:
			return message != null ? new HttpClientErrorException.Forbidden(message, statusText, headers, body, charset)
					: new HttpClientErrorException.Forbidden(statusText, headers, body, charset);
		case NOT_FOUND:
			return message != null ? new HttpClientErrorException.NotFound(message, statusText, headers, body, charset)
		...
		case CONFLICT:
			return message != null ? new HttpClientErrorException.Conflict(message, statusText, headers, body, charset)
					: new HttpClientErrorException.Conflict(statusText, headers, body, charset);
		case GONE:
			return message != null ? new HttpClientErrorException.Gone(message, statusText, headers, body, charset)
	...
	public static final class BadRequest extends HttpClientErrorException {
		...
		private BadRequest(String message, String statusText, HttpHeaders headers, byte[] body,
	...
	public static final class Unauthorized extends HttpClientErrorException {
		...
		private Unauthorized(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class Forbidden extends HttpClientErrorException {
		...
		private Forbidden(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class NotFound extends HttpClientErrorException {
		...
		private NotFound(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class MethodNotAllowed extends HttpClientErrorException {
		...
		private MethodNotAllowed(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class NotAcceptable extends HttpClientErrorException {
		...
		private NotAcceptable(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class Conflict extends HttpClientErrorException {
		...
		private Conflict(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class UnsupportedMediaType extends HttpClientErrorException {
		...
		private UnsupportedMediaType(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class UnprocessableEntity extends HttpClientErrorException {
		...
		private UnprocessableEntity(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
	...
	public static final class TooManyRequests extends HttpClientErrorException {
		...
		private TooManyRequests(String message, String statusText, HttpHeaders headers, byte[] body,
				@Nullable Charset charset) {
