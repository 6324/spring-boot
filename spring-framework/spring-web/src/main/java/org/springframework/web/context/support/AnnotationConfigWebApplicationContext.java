 ...
 * ContextLoader and/or "contextClass" init-param for FrameworkServlet must be set to the
 ...
 * code-based alternative to {@code web.xml}. See its Javadoc for details and usage
 * examples.
 *
 * <p>
 * Unlike {@link XmlWebApplicationContext}, no default configuration class locations are
 * assumed. Rather, it is a requirement to set the
 * {@linkplain ContextLoader#CONFIG_LOCATION_PARAM "contextConfigLocation"} context-param
 * for {@link ContextLoader} and/or "contextConfigLocation" init-param for
 * FrameworkServlet. The param-value may contain both fully-qualified class names and base
 * packages to scan for components. See {@link #loadBeanDefinitions} for exact details on
 * how these locations are processed.
 *
 * <p>
 * As an alternative to setting the "contextConfigLocation" parameter, users may implement
 * an {@link org.springframework.context.ApplicationContextInitializer
 * ApplicationContextInitializer} and set the
 * {@linkplain ContextLoader#CONTEXT_INITIALIZER_CLASSES_PARAM
 * "contextInitializerClasses"} context-param / init-param. In such cases, users should
 * favor the {@link #refresh()} and {@link #scan(String...)} methods over the
 * {@link #setConfigLocation(String)} method, which is primarily for use by
 * {@code ContextLoader}.
 *
 * <p>
...
public class AnnotationConfigWebApplicationContext extends AbstractRefreshableWebApplicationContext
	 ...
	 * @param componentClasses one or more component classes, e.g.
	 ...
	 * value is a package and attempt to scan it for component classes.
	 * <p>
	...
	public Class<?> getType(String name, boolean allowFactoryBeanInit) throws NoSuchBeanDefinitionException {
		System.out.println("调试getType");
		return null;
	}

	@Override
	public String[] getBeanNamesForType(ResolvableType type, boolean includeNonSingletons, boolean allowEagerInit) {
		System.out.println("调试getBeanNamesForType" + this.getClass().getPackage());
		return new String[0];
	}
