 ...
 * supports GET, HEAD, POST, PUT, PATCH and DELETE only. DispatcherServlet will process
 * TRACE and OPTIONS with the default HttpServlet behavior unless explicitly told to
 * dispatch those request types as well: Check out the "dispatchOptionsRequest" and
 * "dispatchTraceRequest" properties, switching them to "true" if necessary.
 *
