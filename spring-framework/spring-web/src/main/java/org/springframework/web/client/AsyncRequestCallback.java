 ...
 * {@link org.springframework.http.client.AsyncClientHttpRequest}. Allows to manipulate
 * the request headers, and write to the request body.
 *
 * <p>
...
public interface AsyncRequestCallback {
	...
	/**
	 * Gets called by {@link AsyncRestTemplate#execute} with an opened
	 * {@code ClientHttpRequest}. Does not need to care about closing the request or about
	 * handling errors: this will all be handled by the {@code RestTemplate}.
