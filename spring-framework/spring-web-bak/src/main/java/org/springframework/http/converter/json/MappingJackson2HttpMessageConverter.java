 ...
 * can read and write JSON using <a href="https://github.com/FasterXML/jackson">Jackson
 ...
 * {@code application/*+json} with {@code UTF-8} character set. This can be overridden by
