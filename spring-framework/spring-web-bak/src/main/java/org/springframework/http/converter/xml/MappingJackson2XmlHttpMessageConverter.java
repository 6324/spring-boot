 ...
 * HttpMessageConverter} that can read and write XML using
 * <a href="https://github.com/FasterXML/jackson-dataformat-xml"> Jackson 2.x extension
 * component for reading and writing XML encoded data</a>.
 *
 * <p>
...
public class MappingJackson2XmlHttpMessageConverter extends AbstractJackson2HttpMessageConverter {
	...
	/**
	 * Construct a new {@code MappingJackson2XmlHttpMessageConverter} using default
	...
	/**
	 * Construct a new {@code MappingJackson2XmlHttpMessageConverter} with a custom
	 * {@link ObjectMapper} (must be a {@link XmlMapper} instance). You can use
	...
	/**
	 * {@inheritDoc} The {@code ObjectMapper} parameter must be a {@link XmlMapper}
	 * instance.
	 */
	@Override
