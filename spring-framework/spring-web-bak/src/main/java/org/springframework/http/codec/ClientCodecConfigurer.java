...
public interface ClientCodecConfigurer extends CodecConfigurer {
	 ...
	 * {@inheritDoc}
	 * <p>
	 * On the client side, built-in default also include customizations related to
	 * multipart readers and writers, as well as the decoder for SSE.
	 */
	@Override
	...
	interface ClientDefaultCodecs extends DefaultCodecs {
		 ...
		 * {@link #jackson2JsonDecoder} override is used instead. Use this property if you
		 * want to further customize the SSE decoder.
		 * <p>
