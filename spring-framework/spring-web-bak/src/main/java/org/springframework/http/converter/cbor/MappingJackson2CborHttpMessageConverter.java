 ...
 * data format using
 * <a href="https://github.com/FasterXML/jackson-dataformats-binary/tree/master/cbor"> the
 * dedicated Jackson 2.x extension</a>.
 *
 * <p>
 * By default, this converter supports the {@link MediaType#APPLICATION_CBOR_VALUE} media
 * type. This can be overridden by setting the {@link #setSupportedMediaTypes
...
public class MappingJackson2CborHttpMessageConverter extends AbstractJackson2HttpMessageConverter {
	...
	/**
	 * Construct a new {@code MappingJackson2CborHttpMessageConverter} using the default
	...
	/**
	 * Construct a new {@code MappingJackson2CborHttpMessageConverter} with a custom
	 * {@link ObjectMapper} (must be configured with a {@code CBORFactory} instance).
	 * <p>
