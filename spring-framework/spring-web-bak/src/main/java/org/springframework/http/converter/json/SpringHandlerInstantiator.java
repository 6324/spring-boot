 ...
 * {@link KeyDeserializer}, {@link TypeResolverBuilder}, {@link TypeIdResolver}) beans
 * with autowiring against a Spring {@link ApplicationContext}.
 *
 * <p>
 * As of Spring 4.3, this overrides all factory methods in {@link HandlerInstantiator},
 * including non-abstract ones and recently introduced ones from Jackson 2.4 and 2.5: for
