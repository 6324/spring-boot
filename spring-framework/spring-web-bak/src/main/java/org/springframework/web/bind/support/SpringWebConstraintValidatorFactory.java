...
/**
 * JSR-303 {@link ConstraintValidatorFactory} implementation that delegates to the current
 * Spring {@link WebApplicationContext} for creating autowired {@link ConstraintValidator}
 * instances.
 *
 * <p>
 * In contrast to
...
public class SpringWebConstraintValidatorFactory implements ConstraintValidatorFactory {
	...
	/**
	 * Retrieve the Spring {@link WebApplicationContext} to use. The default
	 * implementation returns the current {@link WebApplicationContext} as registered for
