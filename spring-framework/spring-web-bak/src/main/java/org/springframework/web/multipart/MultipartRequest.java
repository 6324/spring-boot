...
/**
 * This interface defines the multipart request access operations that are exposed for
 * actual multipart requests. It is extended by {@link MultipartHttpServletRequest}.
 *
...
public interface MultipartRequest {
	...
	/**
	 * Return an {@link java.util.Iterator} of String objects containing the parameter
	 * names of the multipart files contained in this request. These are the field names
	 * of the form (like with normal parameters), not the original file names.
	...
	/**
	 * Return the contents plus description of uploaded files in this request, or an empty
	 ...
	 * @return a map containing the parameter names as keys, and the {@link MultipartFile}
	 * objects as values
	 */
