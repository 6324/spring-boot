 ...
 * to and also encapsulating a specific {@link ConversionService} to use for formatting
 * method argument values as Strings.
 *
...
public class CompositeUriComponentsContributor implements UriComponentsContributor {
	...
	/**
	 * Determine if this {@code CompositeUriComponentsContributor} has any contributors.
	 * @return {@code true} if this {@code CompositeUriComponentsContributor} was created
	 * with contributors to delegate to
	 */
