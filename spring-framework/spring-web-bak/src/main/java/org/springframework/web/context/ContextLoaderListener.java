 ...
 * {@link WebApplicationContext}. Simply delegates to {@link ContextLoader} as well as to
 * {@link ContextCleanupListener}.
 *
 * <p>
...
public class ContextLoaderListener extends ContextLoader implements ServletContextListener {
	 ...
	 * <p>
	 * This constructor is typically used when declaring {@code ContextLoaderListener} as
	 * a {@code <listener>} within {@code web.xml}, where a no-arg constructor is
	 * required.
	 * <p>
	 * The created application context will be registered into the ServletContext under
	 * the attribute name
	 * {@link WebApplicationContext#ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE} and the Spring
	 ...
	 * {@link ConfigurableWebApplicationContext} and (b) has <strong>not</strong> already
	 ...
	 * {@linkplain org.springframework.context.ConfigurableApplicationContext#setId id},
	 ...
	 * init-param will be applied.</li>
	 * <li>{@link org.springframework.context.ConfigurableApplicationContext#refresh
