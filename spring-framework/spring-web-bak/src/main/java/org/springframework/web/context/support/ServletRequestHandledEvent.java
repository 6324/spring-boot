...
/**
 * Servlet-specific subclass of RequestHandledEvent, adding servlet-specific context
 * information.
 *
...
public class ServletRequestHandledEvent extends RequestHandledEvent {
	 ...
	 */
	public ServletRequestHandledEvent(Object source, String requestUrl, String clientAddress, String method,
			String servletName, @Nullable String sessionId, @Nullable String userName, long processingTimeMillis) {
	...
	public ServletRequestHandledEvent(Object source, String requestUrl, String clientAddress, String method,
			String servletName, @Nullable String sessionId, @Nullable String userName, long processingTimeMillis,
			@Nullable Throwable failureCause, int statusCode) {
	...
	/**
	 * Return the HTTP status code of the response or -1 if the status code is not
	 * available.
	 * @since 4.1
	 */
