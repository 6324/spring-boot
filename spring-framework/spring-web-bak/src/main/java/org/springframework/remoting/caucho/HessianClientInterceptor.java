 ...
 * Supports authentication via username and password. The service URL must be an HTTP URL
 * exposing a Hessian service.
 *
 * <p>
 * Hessian is a slim, binary RPC protocol. For information on Hessian, see the
 * <a href="http://hessian.caucho.com">Hessian website</a> <b>Note: As of Spring 4.0, this
 * client requires Hessian 4.0 or above.</b>
 *
 * <p>
 * Note: There is no requirement for services accessed with this proxy factory to have
 * been exported using Spring's {@link HessianServiceExporter}, as there is no special
 * handling involved. As a consequence, you can also access services that have been
 * exported using Caucho's {@link com.caucho.hessian.server.HessianServlet}.
 *
...
public class HessianClientInterceptor extends UrlBasedRemoteAccessor implements MethodInterceptor {
	...
	/**
	 * Set whether overloaded methods should be enabled for remote invocations. Default is
	 * "false".
	...
	/**
	 * Set the username that this factory should use to access the remote service. Default
	 * is none.
	 * <p>
	...
	/**
	 * Set the password that this factory should use to access the remote service. Default
	 * is none.
	 * <p>
