...
/**
 * HTTP request handler that exports the specified service bean as Hessian service
 * endpoint, accessible via a Hessian proxy. Designed for Sun's JRE 1.6 HTTP server,
 ...
 *
 * <p>
 * Hessian services exported with this class can be accessed by any Hessian client, as
 * there isn't any special handling involved.
 *
