...
public class CustomSQLExceptionTranslatorRegistrar implements InitializingBean {
	...
	/**
	 * Setter for a Map of {@link SQLExceptionTranslator} references where the key must be
	 * the database name as defined in the {@code sql-error-codes.xml} file.
	 * <p>
	...
	public void afterPropertiesSet() {
		this.translators.forEach((dbName, translator) -> CustomSQLExceptionTranslatorRegistry.getInstance()
