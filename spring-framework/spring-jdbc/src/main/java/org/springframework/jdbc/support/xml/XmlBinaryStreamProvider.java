...
/**
 * Interface defining handling involved with providing {@code OutputStream} data for XML
 * input.
 *
...
public interface XmlBinaryStreamProvider {
	 ...
	 * {@code OutputStream}.
	 * @param outputStream the {@code OutputStream} object being used to provide the XML
	 * input
