...
/**
 * {@link DataFieldMaxValueIncrementer} that increments the maximum value of a given SQL
 * Server table with the equivalent of an auto-increment column. Note: If you use this
 * class, your table key column should <i>NOT</i> be defined as an IDENTITY column, as the
 ...
 * method, it is recommended to use IDENTITY columns directly in the tables and then using
 * a {@link org.springframework.jdbc.core.simple.SimpleJdbcInsert} or utilizing a
