...
public interface TableMetaDataProvider {
	...
	/**
	 * Initialize using provided database meta-data, table and column information. This
	 * initialization can be turned off by specifying that column meta-data should not be
	 * used.
	 * @param databaseMetaData used to retrieve database specific information
	...
	/**
	 * Get the table name formatted based on meta-data information. This could include
	 * altering the case.
	 */
	@Nullable
	...
	/**
	 * Get the catalog name formatted based on meta-data information. This could include
	 * altering the case.
	 */
	@Nullable
	...
	/**
	 * Get the schema name formatted based on meta-data information. This could include
	 * altering the case.
	 */
	@Nullable
	...
	/**
	 * Does this database support a simple query to retrieve the generated key when the
	 * JDBC 3.0 feature of retrieving generated keys is not supported?
	 ...
	 * keys: {@link java.sql.Connection#createStruct(String, Object[])}?
	 */
