 ...
 * We might need to do this to make use of proprietary features, available only with a
...
public interface ParameterMapper {
	 ...
	 * @param con a JDBC connection. This is useful (and the purpose of this interface) if
	 * we need to do something RDBMS-specific with a proprietary Connection implementation
	 * class. This class conceals such proprietary details. However, it is best to avoid
	 * using such proprietary RDBMS features if possible.
