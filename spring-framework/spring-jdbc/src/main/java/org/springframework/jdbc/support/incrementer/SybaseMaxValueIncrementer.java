 ...
 * Sybase table with the equivalent of an auto-increment column. Note: If you use this
 ...
 *
 * <b>HINT:</b> Since Sybase Adaptive Server supports the JDBC 3.0
 * {@code getGeneratedKeys} method, it is recommended to use IDENTITY columns directly in
 * the tables and then using a
 * {@link org.springframework.jdbc.core.simple.SimpleJdbcInsert} or utilizing a
