 ...
 *
 * <p>
 * Simplifies MappingSqlQueryWithParameters API by dropping parameters and context. Most
 * subclasses won't care about parameters. If you don't use contextual information,
 * subclass this instead of MappingSqlQueryWithParameters.
 *
 * @author Rod Johnson
...
public abstract class MappingSqlQuery<T> extends MappingSqlQueryWithParameters<T> {
	...
	/**
	 * This method is implemented to invoke the simpler mapRow template method, ignoring
	 * parameters.
	 ...
	 * MappingSqlQueryWithParameters, don't need to concern themselves with the parameters
	 * to the execute method of the query object.
