 ...
 *
 * <p>
 * A {@link ResultSetExtractor}, {@link RowCallbackHandler} or {@link RowMapper} must be
 * provided to handle any returned rows.
 *
 * <p>
...
public class SqlReturnResultSet extends ResultSetSupportingSqlParameter {
	 ...
	 * @param extractor the {@link ResultSetExtractor} to use for parsing the
	 ...
	 * Create a new instance of the {@link SqlReturnResultSet} class.
	 * @param name the name of the parameter, as used in input and output maps
	 * @param handler the {@link RowCallbackHandler} to use for parsing the
	 * {@link java.sql.ResultSet}
	 */
	 ...
	 * Create a new instance of the {@link SqlReturnResultSet} class.
	 * @param name the name of the parameter, as used in input and output maps
	 * @param mapper the {@link RowMapper} to use for parsing the
	 * {@link java.sql.ResultSet}
	 */
