...
/**
 * Base class for {@link SQLExceptionTranslator} implementations that allow for fallback
 * to some other {@link SQLExceptionTranslator}.
 *
...
public abstract class AbstractFallbackSQLExceptionTranslator implements SQLExceptionTranslator {
	 ...
	 * {@link SQLStateSQLExceptionTranslator}).
	 */
	 ...
	 * <p>
	 * The passed-in arguments will have been pre-checked. Furthermore, this method is
	 * allowed to return {@code null} to indicate that no exception match has been found
	 * and that fallback translation should kick in.
