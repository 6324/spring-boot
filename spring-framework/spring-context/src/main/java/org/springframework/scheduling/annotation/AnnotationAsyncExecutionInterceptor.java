...
public class AnnotationAsyncExecutionInterceptor extends AsyncExecutionInterceptor {
	 ...
	 * executor has been qualified at the method level using {@link Async#value()}; as of
	 * 4.2.6, a local executor for this interceptor will be built otherwise
	 */
	 ...
	 * exceptions thrown by asynchronous method executions with {@code void} return type
	 */
	public AnnotationAsyncExecutionInterceptor(@Nullable Executor defaultExecutor,
	 ...
	 * given method, specified via {@link Async#value} at the method or declaring class
	 * level. If {@code @Async} is specified at both the method and class level, the
	 * method's {@code #value} takes precedence (even if empty string, indicating that the
	 * default executor should be used preferentially).
