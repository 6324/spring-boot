 ...
 * {@link java.util.concurrent.Executor} that can be found in JNDI. The actual adapting to
 * {@link javax.enterprise.concurrent.ManagedExecutorService} happens in the base class
 * {@link ConcurrentTaskExecutor} itself.
 *
