...
/**
 * A representation of a scheduled task at runtime, used as a return value for scheduling
 * methods.
 *
...
public final class ScheduledTask {
	...
	/**
	 * Return the underlying task (typically a {@link CronTask}, {@link FixedRateTask} or
	 * {@link FixedDelayTask}).
	 * @since 5.0.2
	 */
	public Task getTask() {
