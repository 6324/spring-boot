...
/**
 * Enables Spring's scheduled task execution capability, similar to functionality found in
 * Spring's {@code <task:*>} XML namespace. To be used on @{@link Configuration} classes
 * as follows:
 *
 * <pre class="code">
 * &#064;Configuration
 ...
 * }</pre>
 *
 * This enables detection of @{@link Scheduled} annotations on any Spring-managed bean in
 * the container. For example, given a class {@code MyTask}
 *
 * <pre class="code">
 ...
 * }</pre>
 *
 * the following configuration would ensure that {@code MyTask.work()} is called once
 * every 1000 ms:
 *
 * <pre class="code">
 * &#064;Configuration
 ...
 * configuration would ensure that its {@code @Scheduled} method is invoked at the desired
 * interval:
 *
 * <pre class="code">
 * &#064;Configuration
 ...
 * {@link org.springframework.scheduling.TaskScheduler} bean in the context, or a
 * {@code TaskScheduler} bean named "taskScheduler" otherwise; the same lookup will also
 * be performed for a {@link java.util.concurrent.ScheduledExecutorService} bean. If
 * neither of the two is resolvable, a local single-threaded default scheduler will be
 ...
 * demonstrates how to customize the {@link Executor} used to execute scheduled tasks:
 *
 * <pre class="code">
 * &#064;Configuration
 * &#064;EnableScheduling
 ...
 *
 * <p>
 * Implementing {@code SchedulingConfigurer} also allows for fine-grained control over
 * task registration via the {@code ScheduledTaskRegistrar}. For example, the following
 * configures the execution of a particular bean method per a custom {@code Trigger}
 * implementation:
 *
 * <pre class="code">
 * &#064;Configuration
