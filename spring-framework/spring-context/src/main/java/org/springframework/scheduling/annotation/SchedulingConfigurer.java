 ...
 * annotated with @{@link EnableScheduling}. Typically used for setting a specific
 ...
 * annotation. For example, this may be necessary when implementing
 * {@link org.springframework.scheduling.Trigger Trigger}-based tasks, which are not
 * supported by the {@code @Scheduled} annotation.
 *
 * <p>
