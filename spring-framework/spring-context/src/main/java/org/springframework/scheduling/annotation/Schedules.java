 ...
 *
 * <p>
 * Can be used natively, declaring several nested {@link Scheduled} annotations. Can also
 * be used in conjunction with Java 8's support for repeatable annotations, where
 * {@link Scheduled} can simply be declared several times on the same method, implicitly
