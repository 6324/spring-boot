...
/**
 * {@link JndiLocatorSupport} subclass with public lookup methods, for convenient use as a
 * delegate.
 *
...
public class JndiLocatorDelegate extends JndiLocatorSupport {
	...
	/**
	 * System property that instructs Spring to ignore a default JNDI environment, i.e. to
	 * always return {@code false} from {@link #isDefaultJndiEnvironmentAvailable()}.
	 * <p>
	 ...
	 * for scenarios where nothing is ever to be found for such JNDI fallback searches to
	 * begin with, avoiding the repeated JNDI lookup overhead.
	 * <p>
	 ...
	 * {@code JndiLocatorDelegate.isDefaultJndiEnvironmentAvailable()} check: in
	 * particular, {@code StandardServletEnvironment} and
	 * {@code StandardPortletEnvironment}.
	 * @since 4.3
	...
	/**
	 * Check whether a default JNDI environment, as in a Java EE environment, is available
	 * on this JVM.
