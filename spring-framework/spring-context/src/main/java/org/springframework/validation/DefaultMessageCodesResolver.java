 ...
 *
 * <p>
 * Will create two message codes for an object error, in the following order (when using
 * the {@link Format#PREFIX_ERROR_CODE prefixed}
 ...
 *
 * <p>
 * This resolution algorithm thus can be leveraged for example to show specific messages
 * for binding errors like "required" and "typeMismatch":
 * <ul>
 ...
 *
 * <p>
 * In case of array, {@link List} or {@link java.util.Map} properties, both codes for
 * specific elements and for the whole collection are generated. Assuming a field "name"
 * of an array "groups" in object "user":
 * <ul>
 ...
 *
 * <p>
 * In order to group all codes into a specific category within your resource bundles, e.g.
 * "validation.typeMismatch.name" instead of the default "typeMismatch.name", consider
 * specifying a {@link #setPrefix prefix} to be applied.
 *
...
public class DefaultMessageCodesResolver implements MessageCodesResolver, Serializable {
	 ...
	 * <p>
	 * Default is none. Specify, for example, "validation." to get error codes like
	 ...
	 * <p>
	 * Arrays, Lists and Maps are resolved both for specific elements and the whole
	 * collection.
	 * <p>
	 * See the {@link DefaultMessageCodesResolver class level javadoc} for details on the
	 * generated codes.
	...
	private void addCodes(Collection<String> codeList, String errorCode, @Nullable String objectName,
	...
	private void addCode(Collection<String> codeList, String errorCode, @Nullable String objectName,
			@Nullable String field) {
		codeList.add(postProcessMessageCode(this.formatter.format(errorCode, objectName, field)));
	}

	/**
	 * Add both keyed and non-keyed entries for the supplied {@code field} to the supplied
	 * field list.
	 */
