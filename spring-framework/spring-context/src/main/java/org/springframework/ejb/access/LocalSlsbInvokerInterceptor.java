...
/**
 * Invoker for a local Stateless Session Bean. Designed for EJB 2.x, but works for EJB 3
 * Session Beans as well.
 *
 * <p>
 * Caches the home object, since a local EJB home can never go stale. See
...
public class LocalSlsbInvokerInterceptor extends AbstractSlsbInvokerInterceptor {
	 ...
	 * hold a single shared EJB instance.
	 */
	@Override
	@Nullable
	...
	/**
	 * Release the given EJB instance. Default implementation delegates to
	...
	/**
	 * Return a new instance of the stateless session bean. Can be overridden to change
	 * the algorithm.
	 * @throws NamingException if thrown by JNDI
	 * @throws InvocationTargetException if thrown by the create method
	 * @see #create
