...
/**
 * Static implementation of the {@link org.springframework.scripting.ScriptSource}
 * interface, encapsulating a given String that contains the script source text. Supports
 * programmatic updates of the script String.
 *
 * @author Rob Harrop
