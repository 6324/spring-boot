 ...
 *
 * <p>
 * Aside from language-specific implementations, Spring also ships a version based on the
 * standard {@code javax.script} package (JSR-223):
...
public interface ScriptEvaluator {
	 ...
	 * @throws ScriptCompilationException if the evaluator failed to read, compile or
	 * evaluate the script
	 */
	@Nullable
	 ...
	 * @param script the ScriptSource for the script to evaluate
	 * @param arguments the key-value pairs to expose to the script, typically as script
	 * variables (may be {@code null} or empty)
	 * @return the return value of the script, if any
	 * @throws ScriptCompilationException if the evaluator failed to read, compile or
	 * evaluate the script
	 */
