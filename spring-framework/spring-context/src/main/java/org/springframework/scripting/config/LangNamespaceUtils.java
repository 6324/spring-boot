...
public abstract class LangNamespaceUtils {
	...
	/**
	 * The unique name under which the internally managed
	 * {@link ScriptFactoryPostProcessor} is registered in the
	 ...
	 * @param registry the {@link BeanDefinitionRegistry} to register the script processor
	 * with
	 * @return the {@link ScriptFactoryPostProcessor} bean definition (new or already
	 * registered)
	 */
