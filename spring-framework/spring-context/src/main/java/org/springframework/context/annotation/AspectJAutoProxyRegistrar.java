 ...
 * {@link BeanDefinitionRegistry} as appropriate based on a
 * given @{@link EnableAspectJAutoProxy} annotation.
 *
 * @author Chris Beams
...
class AspectJAutoProxyRegistrar implements ImportBeanDefinitionRegistrar {
	 ...
	 * of the @{@link EnableAspectJAutoProxy#proxyTargetClass()} attribute on the
