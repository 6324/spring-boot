...
public interface MessageSourceResolvable {
	...
	/**
	 * Return the codes to be used to resolve this message, in the order that they should
	 * get tried. The last code will therefore be the default one.
	 ...
	 * @return an array of objects to be used as parameters to replace placeholders within
	 * the message text
	 ...
	 * <p>
	 * The default implementation simply returns {@code null}. Note that the default
	 * message may be identical to the primary message code ({@link #getCodes()}), which
