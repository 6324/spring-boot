 ...
 * {@code <import/>} element in Spring XML. It is typically used when designing
 ...
 * GroovyBeanDefinitionReader} if ending in {@code ".groovy"}; otherwise, an
 * {@link org.springframework.beans.factory.xml.XmlBeanDefinitionReader
 * XmlBeanDefinitionReader} will be used to parse Spring {@code <beans/>} XML files.
 * Optionally, the {@link #reader} attribute may be declared, allowing the user to choose
 * a custom {@link BeanDefinitionReader} implementation.
 *
 * @author Chris Beams
...
public @interface ImportResource {
	 ...
	 * <p>
	 * Consult the Javadoc for {@link #reader} for details on how resources will be
	 * processed.
	 * @since 4.2
	 * @see #value
	 * @see #reader
	 ...
	 * {@link org.springframework.beans.factory.groovy.GroovyBeanDefinitionReader
	 * GroovyBeanDefinitionReader}; whereas, all other resources will be processed with an
	 * {@link org.springframework.beans.factory.xml.XmlBeanDefinitionReader
