 ...
 *
 * <p>
 * {@code SimpleThreadScope} <em>does not clean up any objects</em> associated with it. It
 * is therefore typically preferable to use a request-bound scope implementation such as
 * {@code org.springframework.web.context.request.RequestScope} in web environments,
 ...
 * callbacks, refer to <a href=
 * "https://www.springbyexample.org/examples/custom-thread-scope-module.html">Spring by
 * Example</a>.
 *
 * <p>
