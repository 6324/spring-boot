 ...
 * {@link AnnotatedBeanDefinitionReader} for standard JSR-330 compliance. However, in
 * practice, you will typically use Spring's rich default scoping instead - or extend this
 * resolver with custom scoping annotations that point to extended Spring scopes.
 *
...
public class Jsr330ScopeMetadataResolver implements ScopeMetadataResolver {
	...
	/**
	 * Register an extended JSR-330 scope annotation, mapping it onto a specific Spring
	 * scope by name.
	 ...
	 * <p>
	 * The default implementation simply checks against registered scopes. Can be
	 * overridden for custom mapping rules, e.g. naming conventions.
