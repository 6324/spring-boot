 ...
 * implement/extend any of its artifacts as a set of configuration classes is not a
 * {@link Resource}.
 *
 * @author Chris Beams
...
class ConfigurationClassBeanDefinitionReader {
	...
	/**
	 * Create a new {@link ConfigurationClassBeanDefinitionReader} instance that will be
	 * used to populate the given {@link BeanDefinitionRegistry}.
	 */
	...
	/**
	 * Read {@code configurationModel}, registering bean definitions with the registry
	 ...
	 * class itself and all of its {@link Bean} methods.
	 */
	 ...
	 */
	@SuppressWarnings("deprecation") // for
	...
	private void loadBeanDefinitionsForBeanMethod(BeanMethod beanMethod) {
		...
		if (proxyMode != ScopedProxyMode.NO) {
			...
			beanDefToRegister = new ConfigurationClassBeanDefinition((RootBeanDefinition) proxyDef.getBeanDefinition(),
	...
	protected boolean isOverriddenByExistingDefinition(BeanMethod beanMethod, String beanName) {
		...
		// Is the existing bean definition one that was created from a configuration
		// class?
		// -> allow the current bean method to override, since both are at second-pass
		// level.
		// However, if the bean method is an overloaded case on the same configuration
		// class,
		// preserve the existing bean definition.
		if (existingBeanDef instanceof ConfigurationClassBeanDefinition) {
			ConfigurationClassBeanDefinition ccbd = (ConfigurationClassBeanDefinition) existingBeanDef;
			if (ccbd.getMetadata().getClassName()
		...
		// At this point, it's a top-level override (probably XML), just having been
		// parsed
	 ...
	 * was created from a configuration class as opposed to any other configuration
	...
	/**
	 * Evaluate {@code @Conditional} annotations, tracking results and taking into account
	 * 'imported by'.
	 */
