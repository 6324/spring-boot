...
abstract class BeanAnnotationHelper {
	...
	public static String determineBeanNameFor(Method beanMethod) {
		...
		if (beanName == null) {
			...
			AnnotationAttributes bean = AnnotatedElementUtils.findMergedAnnotationAttributes(beanMethod, Bean.class,
					false, false);
			if (bean != null) {
	...
	public static boolean isScopedProxy(Method beanMethod) {
		...
		if (scopedProxy == null) {
			AnnotationAttributes scope = AnnotatedElementUtils.findMergedAnnotationAttributes(beanMethod, Scope.class,
					false, false);
