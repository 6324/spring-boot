 ...
 *
 * <p>
 * Allows for registering classes one by one using {@link #register(Class...)} as well as
 * for classpath scanning using {@link #scan(String...)}.
 *
 * <p>
 * In case of multiple {@code @Configuration} classes, {@link Bean @Bean} methods defined
 * in later classes will override those defined in earlier classes. This can be leveraged
...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	 ...
	 * given component classes and automatically refreshing the context.
	...
	/**
	 * Create a new AnnotationConfigApplicationContext, scanning for components in the
	 * given packages, registering bean definitions for those components, and
