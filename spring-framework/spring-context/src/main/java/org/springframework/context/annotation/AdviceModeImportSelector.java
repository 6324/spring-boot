...
public abstract class AdviceModeImportSelector<A extends Annotation> implements ImportSelector {
	 ...
	 * generic type {@code A}. The default is
	 * {@value #DEFAULT_ADVICE_MODE_ATTRIBUTE_NAME}, but subclasses may override in order
	 * to customize.
	 */
	 ...
	 * @throws IllegalArgumentException if expected annotation {@code A} is not present on
	 * the importing {@code @Configuration} class or if {@link #selectImports(AdviceMode)}
	 * returns {@code null}
	 */
	@Override
	 ...
	 * be thrown.
	 * @param adviceMode the value of the {@linkplain #getAdviceModeAttributeName() advice
	 * mode attribute} for the annotation specified via generics.
