 ...
 *
 * <p>
 * Used by {@link org.springframework.remoting.rmi.RmiClientInterceptor} (for RMI
 * invokers) and by
...
public interface RemoteInvocationFactory {
	 ...
	 * <p>
	 * Can be implemented to add custom context information to the remote invocation, for
