...
/**
 * An implementation of the {@code ObjectNamingStrategy} interface that creates a name
 * based on the identity of a given instance.
 *
 * <p>
 * The resulting {@code ObjectName} will be in the form <i>package</i>:class=<i>class
...
public class IdentityNamingStrategy implements ObjectNamingStrategy {
	...
	/**
	 * Returns an instance of {@code ObjectName} based on the identity of the managed
	 * resource.
	 */
	@Override
