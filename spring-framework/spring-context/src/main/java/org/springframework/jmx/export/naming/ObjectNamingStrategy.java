 ...
 *
 * <p>
 * Used by the {@code MBeanExporter} to obtain {@code ObjectName}s when registering beans.
 *
 * @author Rob Harrop
 * @since 1.2
...
public interface ObjectNamingStrategy {
	 ...
	 * @param managedBean the bean that will be exposed under the returned
	 * {@code ObjectName}
	 * @param beanKey the key associated with this bean in the beans map passed to the
	 * {@code MBeanExporter}
