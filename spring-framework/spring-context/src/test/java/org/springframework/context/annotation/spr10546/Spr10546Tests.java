...
public class Spr10546Tests {
	 ...
	 *
	 * <p>
	 * We purposely use the {@link AEnclosingConfig} to make it alphabetically prior to
	 * the {@link AEnclosingConfig.ChildConfig} which encourages this to occur with the
	...
	public void enclosingConfigFirstParentDefinesBeanWithImportResource() {
		assertLoadsMyBean(AEnclosingWithImportResourceConfig.class,
