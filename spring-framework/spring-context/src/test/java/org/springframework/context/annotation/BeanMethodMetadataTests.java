...
public class BeanMethodMetadataTests {
	...
	public void providesBeanMethodBeanDefinition() throws Exception {
		...
		assertThat(beanDefinition).as("should provide AnnotatedBeanDefinition")
				.isInstanceOf(AnnotatedBeanDefinition.class);
		Map<String, Object> annotationAttributes = ((AnnotatedBeanDefinition) beanDefinition).getFactoryMethodMetadata()
