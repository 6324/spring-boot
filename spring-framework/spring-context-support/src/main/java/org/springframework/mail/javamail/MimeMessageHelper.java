...
public class MimeMessageHelper {
	 ...
	 * be added to (can be the same as the root multipart object, or an element nested
	 * underneath the root multipart element)
	 */
	 ...
	 * <p>
	 * The default is the {@code FileTypeMap} that the underlying MimeMessage carries, if
	 * any, or the Activation Framework's default {@code FileTypeMap} instance else.
	 * @see #addInline
	 * @see #addAttachment
	 ...
	 * <p>
	 * The default is {@code true} for compatibility with older email clients; turn this
	 * to {@code false} for standard MIME behavior. On a related note, check out
	 * JavaMail's {@code mail.mime.encodefilename} system property.
	 * @since 5.2.9
	 ...
	 * setters and adders.
	 * <p>
	 * The default implementation invokes {@link InternetAddress#validate()}, provided
	 * that address validation is activated for the helper instance.
	 ...
	 * body part, surrounded by angle brackets: e.g. "myId" -> "&lt;myId&gt;". Can be
	 * referenced in HTML source via src="cid:myId" expressions.
	...
	public void addAttachment(String attachmentFilename, DataSource dataSource) throws MessagingException {
		...
		try {
			...
			mimeBodyPart
					.setFileName(isEncodeFilenames() ? MimeUtility.encodeText(attachmentFilename) : attachmentFilename);
			mimeBodyPart.setDataHandler(new DataHandler(dataSource));
	 ...
	 */
	protected DataSource createDataSource(final InputStreamSource inputStreamSource, final String contentType,
			final String name) {
