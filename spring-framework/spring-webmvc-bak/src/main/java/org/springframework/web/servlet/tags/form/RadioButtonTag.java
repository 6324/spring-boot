 ...
 *
 * <p>
 * Rendered elements are marked as 'checked' if the configured {@link #setValue(Object)
 * value} matches the {@link #getValue bound value}.
 *
 * <p>
 * A typical usage pattern will involved multiple tag instances bound to the same property
