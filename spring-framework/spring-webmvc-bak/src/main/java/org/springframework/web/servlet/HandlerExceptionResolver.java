 ...
 *
 * <p>
 * Error views are analogous to JSP error pages but can be used with any kind of exception
 * including any checked exception, with potentially fine-grained mappings for specific
 * handlers.
 *
