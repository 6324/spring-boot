...
/**
 * A {@link ResourceTransformer} implementation that helps handling resources within HTML5
 * AppCache manifests for HTML5 offline applications.
 *
 * <p>
 * This transformer:
 * <ul>
 ...
 *
 * <p>
 * All files that have the ".appcache" file extension, or the extension given in the
 * constructor, will be transformed by this class. This hash is computed using the content
 * of the appcache manifest and the content of the linked resources; so changing a
 * resource linked in the manifest or the manifest itself should invalidate the browser
 * cache.
 *
 * <p>
