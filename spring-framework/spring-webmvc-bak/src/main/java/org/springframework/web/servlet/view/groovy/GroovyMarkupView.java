...
public class GroovyMarkupView extends AbstractTemplateView {
	 ...
	 * {@link GroovyMarkupConfig} bean in the web application context and using it to
	 * obtain the configured {@code MarkupTemplateEngine} instance.
	...
	/**
	 * Invoked at startup. If no {@link #setTemplateEngine(MarkupTemplateEngine)
	 * templateEngine} has been manually set, this method looks up a
	 * {@link GroovyMarkupConfig} bean by type and uses it to obtain the Groovy Markup
	 * template engine.
	 * @see GroovyMarkupConfig
	...
	protected MarkupTemplateEngine autodetectMarkupTemplateEngine() throws BeansException {
		try {
			return BeanFactoryUtils
					.beanOfTypeIncludingAncestors(obtainApplicationContext(), GroovyMarkupConfig.class, true, false)
					.getTemplateEngine();
		}
	...
	/**
	 * Return a template compiled by the configured Groovy Markup template engine for the
	 * given view URL.
	 */
