...
/**
 * Simple {@code Controller} implementation that transforms the virtual path of a URL into
 * a view name and returns that view.
 *
 * <p>
 * Can optionally prepend a {@link #setPrefix prefix} and/or append a {@link #setSuffix
 ...
 * <li>{@code "/index.html"} + prefix {@code "pre_"} and suffix
 * {@code "_suf" -> "pre_index_suf"}</li>
...
public class UrlFilenameViewController extends AbstractUrlViewController {
	...
	/**
	 * Returns view name based on the URL filename, with prefix/suffix applied when
	 * appropriate.
	 ...
	 * <p>
	 * The default implementation simply applies prefix and suffix. This can be
	 * overridden, for example, to manipulate upper case / lower case, etc.
