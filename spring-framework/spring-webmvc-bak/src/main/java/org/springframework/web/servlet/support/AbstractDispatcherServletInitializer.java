...
public abstract class AbstractDispatcherServletInitializer extends AbstractContextLoaderInitializer {
	...
	/**
	 * Create a {@link DispatcherServlet} (or other kind of
	 * {@link FrameworkServlet}-derived dispatcher) with the specified
	 * {@link WebApplicationContext}.
	 * <p>
	 * Note: This allows for any {@link FrameworkServlet} subclass as of 4.2.3.
	 * Previously, it insisted on returning a {@link DispatcherServlet} or subclass
	 * thereof.
	 */
	...
	/**
	 * Specify the servlet mapping(s) for the {@code DispatcherServlet} &mdash; for
	 ...
	 * <li>the {@code asyncSupported} flag is set depending on the return value of
	 * {@link #isAsyncSupported() asyncSupported}
	 * <li>a filter mapping is created with dispatcher types {@code REQUEST},
	 * {@code FORWARD}, {@code INCLUDE}, and conditionally {@code ASYNC} depending on the
	 * return value of {@link #isAsyncSupported() asyncSupported}
	 * </ul>
	 * <p>
	 * If the above defaults are not suitable or insufficient, override this method and
	 * register filters directly with the {@code ServletContext}.
