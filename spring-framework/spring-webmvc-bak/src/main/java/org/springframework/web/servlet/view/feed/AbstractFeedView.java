...
public abstract class AbstractFeedView<T extends WireFeed> extends AbstractView {
	 ...
	 * <p>
	 * Default is an empty implementation. Subclasses can override this method to add meta
	 * fields such as title, link description, etc.
	 ...
	 */
	protected abstract void buildFeedEntries(Map<String, Object> model, T feed, HttpServletRequest request,
			HttpServletResponse response) throws Exception;
