...
/**
 * Spring JMS {@link MessageConverter} that uses a {@link Marshaller} and
 * {@link Unmarshaller}. Marshals an object to a {@link BytesMessage}, or to a
 * {@link TextMessage} if the {@link #setTargetType targetType} is set to
 * {@link MessageType#TEXT}. Unmarshals from a {@link TextMessage} or {@link BytesMessage}
 * to an object.
 *
...
public class MarshallingMessageConverter implements MessageConverter, InitializingBean {
	 ...
	 * {@link Unmarshaller} set. The marshaller must be set after construction by invoking
	...
	/**
	 * Construct a new {@code MarshallingMessageConverter} with the given Marshaller and
	 * Unmarshaller.
	...
	/**
	 * Template method that allows for custom message marshalling. Invoked when
	...
	/**
	 * Template method that allows for custom message unmarshalling. Invoked when
	 * {@link #fromMessage(Message)} is invoked with a message that is not a
	 * {@link TextMessage} or {@link BytesMessage}.
	 * <p>
	 * The default implementation throws an {@link IllegalArgumentException}.
	 * @param message the message
	 * @param unmarshaller the unmarshaller to use
