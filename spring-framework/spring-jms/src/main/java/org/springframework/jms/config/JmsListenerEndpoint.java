 ...
 * {@link org.springframework.jms.annotation.JmsListenerConfigurer JmsListenerConfigurer}
...
public interface JmsListenerEndpoint {
	 ...
	 * container to make it usable. Usually, this is about setting the {@code destination}
	 * and the {@code messageListener} to use but an implementation may override any
	 * default setting that was already set.
