 ...
 *
 * <p>
 * Used by {@link org.springframework.jms.core.JmsTemplate} for resolving destination
 * names from simple {@link String Strings} to actual {@link Destination} implementation
 * instances.
 *
 * <p>
...
public interface DestinationResolver {
	...
	/**
	 * Resolve the given destination name, either as located resource or as dynamic
	 * destination.
	 * @param session the current JMS Session (may be {@code null} if the resolver
	 * implementation is able to work without it)
	 ...
	 * @throws DestinationResolutionException in case of general destination resolution
	 * failure
	 */
