 ...
 * from/to generic message headers.
 *
 * @author Mark Fisher
...
public interface JmsHeaders {
	...
	/**
	 * Prefix used for JMS API related headers in order to distinguish from user-defined
	 * headers and other internal headers (e.g. correlationId).
	 * @see SimpleJmsHeaderMapper
	 */
	String PREFIX = "jms_";

	/**
	 * Correlation ID for the message. This may be the {@link #MESSAGE_ID} of the message
	 * that this message replies to. It may also be an application-specific identifier.
	...
	/**
	 * Specify if the message was resent. This occurs when a message consumer fails to
	...
	/**
	 * Message type label. This type is a string value describing the message in a
	 * functional manner.
