 ...
 *
 * <p>
 * JCA 1.5 ActivationSpec objects are typically JavaBeans, but unfortunately
 * provider-specific. This strategy interface allows for plugging in any JCA-based JMS
 * provider, creating corresponding ActivationSpec objects based on common JMS
...
public interface JmsActivationSpecFactory {
	 ...
	 * @return the provider-specific JCA ActivationSpec object, representing the same
	 * settings
	 */
