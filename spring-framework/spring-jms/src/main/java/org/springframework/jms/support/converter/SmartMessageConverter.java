 ...
 *
 * <p>
 * In case of a conversion hint being provided, the framework will call the extended
 * method if a converter implements this interface, instead of calling the regular
 * {@code toMessage} variant.
 *
