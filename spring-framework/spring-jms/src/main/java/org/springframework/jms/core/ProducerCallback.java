 ...
 * {@link ProducerCallback} argument, often implemented as an anonymous inner class or as
 * a lambda expression.
 *
 * <p>
 * The typical implementation will perform multiple operations on the supplied JMS
 * {@link Session} and {@link MessageProducer}.
 *
 * @author Mark Pollack
 * @since 1.1
...
public interface ProducerCallback<T> {
	 ...
	 * <p>
	 * The message producer is not associated with any destination unless when specified
	 * in the JmsTemplate call.
