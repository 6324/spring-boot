...
/**
 * Callback interface for post-processing a JPA PersistenceUnitInfo. Implementations can
 * be registered with a DefaultPersistenceUnitManager or via a
...
public interface PersistenceUnitPostProcessor {
	...
	/**
	 * Post-process the given PersistenceUnitInfo, for example registering further entity
