 ...
 * PersistenceUnitInfos. Used by
 * {@link org.springframework.orm.jpa.LocalContainerEntityManagerFactoryBean} in order to
 * obtain a {@link javax.persistence.spi.PersistenceUnitInfo} for building a concrete
 * {@link javax.persistence.EntityManagerFactory}.
 *
 * <p>
 * Obtaining a PersistenceUnitInfo instance is an exclusive process. A PersistenceUnitInfo
...
public interface PersistenceUnitManager {
	 ...
	 * @throws IllegalStateException if there is no default PersistenceUnitInfo defined or
	 ...
	 * @return the PersistenceUnitInfo (never {@code null})
	 * @throws IllegalArgumentException if no PersistenceUnitInfo with the given name is
	 * defined
	 * @throws IllegalStateException if the PersistenceUnitInfo with the given name has
