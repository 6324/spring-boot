 ...
 * between Spring's
 * {@link org.springframework.orm.jpa.LocalContainerEntityManagerFactoryBean} and
...
public interface SmartPersistenceUnitInfo extends PersistenceUnitInfo {
	 ...
	 * provider. Typically found through scanning but not exposable through
	 * {@link #getManagedClassNames()}.
	...
	/**
	 * Set the persistence provider's own package name, for exclusion from class
	 * transformation.
