...
public class AspectJNamespaceHandlerTests {
	...
	public void setUp() throws Exception {
		...
		XmlReaderContext readerContext = new XmlReaderContext(null, null, this.readerEventListener, sourceExtractor,
				reader, null);
	...
	public void testRegisterAspectJAutoProxyCreator() throws Exception {
		...
		assertThat(definition.getBeanClassName()).as("Incorrect APC class")
	...
	public void testRegisterAspectJAutoProxyCreatorWithExistingAutoProxyCreator() throws Exception {
		...
		BeanDefinition definition = registry.getBeanDefinition(AopConfigUtils.AUTO_PROXY_CREATOR_BEAN_NAME);
		assertThat(definition.getBeanClassName()).as("APC class not switched")
				.isEqualTo(AspectJAwareAdvisorAutoProxyCreator.class.getName());
	}
