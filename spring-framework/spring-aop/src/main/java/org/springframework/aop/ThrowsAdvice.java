 ...
 *
 * The first three arguments are optional, and only useful if we want further information
 * about the joinpoint, as in AspectJ <b>after-throwing</b> advice.
 *
 * <p>
 * <b>Note:</b> If a throws-advice method throws an exception itself, it will override the
 ...
 * coupled to specific target method signatures. <b>Do not throw an undeclared checked
 * exception that is incompatible with the target method's signature!</b>
 *
 * @author Rod Johnson
