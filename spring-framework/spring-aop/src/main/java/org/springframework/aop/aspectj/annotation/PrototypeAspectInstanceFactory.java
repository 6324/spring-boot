 ...
 *
 * <p>
 * Note that this may instantiate multiple times, which probably won't give the semantics
 * you expect. Use a {@link LazySingletonAspectInstanceFactoryDecorator} to wrap this to
 * ensure only one new aspect comes back.
 *
 * @author Rod Johnson
...
public class PrototypeAspectInstanceFactory extends BeanFactoryAspectInstanceFactory implements Serializable {
	...
	/**
	 * Create a PrototypeAspectInstanceFactory. AspectJ will be called to introspect to
