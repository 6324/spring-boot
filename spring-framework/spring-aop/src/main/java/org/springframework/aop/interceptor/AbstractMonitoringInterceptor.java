...
/**
 * Base class for monitoring interceptors, such as performance monitors. Provides
 * configurable "prefix and "suffix" properties that help to classify/group performance
 * monitoring results.
 *
 * <p>
...
public abstract class AbstractMonitoringInterceptor extends AbstractTraceInterceptor {
	...
	/**
	 * Set whether to log the invocation on the target class, if applicable (i.e. if the
	 * method is actually delegated to the target class).
	 * <p>
	...
	/**
	 * Create a {@code String} name for the given {@code MethodInvocation} that can be
	 * used for trace/logging purposes. This name is made up of the configured prefix,
	 * followed by the fully-qualified name of the method being invoked, followed by the
	 * configured suffix.
	 * @see #setPrefix
	 * @see #setSuffix
	 */
