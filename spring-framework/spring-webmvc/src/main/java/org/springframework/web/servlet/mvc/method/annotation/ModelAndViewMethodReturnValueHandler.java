...
/**
 * Handles return values of type {@link ModelAndView} copying view and model information
 * to the {@link ModelAndViewContainer}.
 *
 * <p>
 * If the return value is {@code null}, the
 * {@link ModelAndViewContainer#setRequestHandled(boolean)} flag is set to {@code true} to
 * indicate the request was handled directly.
 *
 * <p>
 * A {@link ModelAndView} return type has a set purpose. Therefore this handler should be
...
public class ModelAndViewMethodReturnValueHandler implements HandlerMethodReturnValueHandler {
	 ...
	 * work. There must be a custom {@link View} that recognizes the prefix as well.
	 * @since 4.1
	 */
