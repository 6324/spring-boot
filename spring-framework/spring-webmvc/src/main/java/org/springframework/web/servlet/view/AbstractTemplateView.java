...
/**
 * Adapter base class for template-based view technologies such as FreeMarker, with the
 * ability to use request and session attributes in their model and the option to expose
 * helper objects for Spring's FreeMarker macro library.
 *
 * <p>
 * JSP/JSTL and other view technologies automatically have access to the
 * HttpServletRequest object and thereby the request/session attributes for the current
 * user. Furthermore, they are able to create and cache helper objects as request
...
public abstract class AbstractTemplateView extends AbstractUrlBasedView {
	...
	/**
	 * Variable name of the RequestContext instance in the template model, available to
	 * Spring's macros: e.g. for creating BindStatus objects.
	 */
	 ...
	 * <p>
	 * Currently needed for Spring's FreeMarker default macros. Note that this is
	 * <i>not</i> required for templates that use HTML forms <i>unless</i> you wish to
	 * take advantage of the Spring helper macros.
	 ...
	 * the given response.
	 * <p>
	 * Only applies the view's contentType if no content type has been set on the response
	 * before. This allows handlers to override the default content type beforehand.
	 ...
	 * @param model combined output Map, with request attributes and session attributes
	 * merged into it if required
	 * @param request current HTTP request
	 * @param response current HTTP response
	 * @throws Exception if rendering failed
	 */
	protected abstract void renderMergedTemplateModel(Map<String, Object> model, HttpServletRequest request,
			HttpServletResponse response) throws Exception;
