...
/**
 * Allows customizing the request before its body is read and converted into an Object and
 * also allows for processing of the resulting Object before it is passed into a
 * controller method as an {@code @RequestBody} or an {@code HttpEntity} method argument.
 *
 * <p>
