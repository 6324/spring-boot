...
/**
 * Contains and delegates calls to a {@link HandlerInterceptor} along with include (and
 * optionally exclude) path patterns to which the interceptor should apply. Also provides
...
public final class MappedInterceptor implements HandlerInterceptor {
	 ...
	 * passed by default to the
	 * {@link #matches(String, org.springframework.util.PathMatcher)} method.
	 * <p>
	 * This is an advanced property that is only required when using custom PathMatcher
	 * implementations that support mapping metadata other than the Ant-style path
