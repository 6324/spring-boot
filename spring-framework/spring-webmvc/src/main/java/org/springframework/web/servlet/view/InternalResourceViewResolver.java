 ...
 * {@link InternalResourceView} (i.e. Servlets and JSPs) and subclasses such as
 * {@link JstlView}.
 *
 * <p>
 * The view class for all views generated by this resolver can be specified via
 * {@link #setViewClass}. See {@link UrlBasedViewResolver}'s javadoc for details. The
 * default is {@link InternalResourceView}, or {@link JstlView} if the JSTL API is
 * present.
 *
 * <p>
 * BTW, it's good practice to put JSP files that just serve as views under WEB-INF, to
 * hide them from direct access (e.g. via a manually entered URL). Only controllers will
 * be able to access them then.
 *
 * <p>
 * <b>Note:</b> When chaining ViewResolvers, an InternalResourceViewResolver always needs
 * to be last, as it will attempt to resolve any view name, no matter whether the
...
public class InternalResourceViewResolver extends UrlBasedViewResolver {
	 ...
	 * default {@link InternalResourceView}, or {@link JstlView} if the JSTL API is
	 * present.
	 */
