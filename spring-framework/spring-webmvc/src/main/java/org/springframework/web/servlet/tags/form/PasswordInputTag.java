...
/**
 * The {@code <password>} tag renders an HTML 'input' tag with type 'password' using the
 * bound value.
 *
 * <p>
 * <table>
...
public class PasswordInputTag extends InputTag {
	...
	/**
	 * Return '{@code password}' causing the rendered HTML '{@code input}' element to have
	 * a '{@code type}' of '{@code password}'.
	 */
	@Override
