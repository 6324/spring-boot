 ...
 * {@code @JsonView} annotation declared on a Spring MVC {@code @RequestMapping} or
 ...
 * the use for a response body advice is only supported with exactly one class argument.
