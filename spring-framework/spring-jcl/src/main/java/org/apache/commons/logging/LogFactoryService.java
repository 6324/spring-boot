 ...
 * case of the standard {@code commons-logging} jar accidentally ending up on the
 * classpath, with the standard {@code LogFactory} class performing its META-INF service
