 ...
 * via {@link #getMatchingCondition(ServerWebExchange)}, and compared to each other via
 * {@link #compareTo(Object, ServerWebExchange)} to determine which is a closer match for
 * a given request.
 *
...
public interface RequestCondition<T> {
	 ...
	 * {@link #getMatchingCondition(ServerWebExchange)} to ensure they have content
