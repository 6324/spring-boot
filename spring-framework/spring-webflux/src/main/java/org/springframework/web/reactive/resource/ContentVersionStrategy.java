...
/**
 * A {@code VersionStrategy} that calculates an Hex MD5 hashes from the content of the
 * resource and appends it to the file name, e.g.
...
public class ContentVersionStrategy extends AbstractFileNameVersionStrategy {
	...
	public Mono<String> getResourceVersion(Resource resource) {
		Flux<DataBuffer> flux = DataBufferUtils.read(resource, dataBufferFactory, StreamUtils.BUFFER_SIZE);
