...
/**
 * A {@code ViewResolver} for resolving {@link FreeMarkerView} instances, i.e. FreeMarker
 * templates and custom subclasses of it.
 *
 * <p>
 * The view class for all views generated by this resolver can be specified via the
 * "viewClass" property. See {@link UrlBasedViewResolver} for details.
 *
