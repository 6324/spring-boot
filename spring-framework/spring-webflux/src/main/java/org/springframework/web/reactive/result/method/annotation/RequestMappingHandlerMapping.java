...
public class RequestMappingHandlerMapping extends RequestMappingInfoHandlerMapping
	 ...
	 * whose controller type is matched by a corresponding {@code Predicate} in the map.
	 * The prefix for the first matching predicate is used, assuming the input map has
	 * predictable order.
	 * <p>
	...
	public void setPathPrefixes(Map<String, Predicate<Class<?>>> prefixes) {
		...
		prefixes.entrySet().stream().filter(entry -> StringUtils.hasText(entry.getKey()))
	...
	/**
	 * Set the {@link RequestedContentTypeResolver} to use to determine requested media
