...
/**
 * Editor for a {@link Character}, to populate a property of type {@code Character} or
 * {@code char} from a String value.
 *
 * <p>
 * Note that the JDK does not contain a default {@link java.beans.PropertyEditor property
 * editor} for {@code char}! {@link org.springframework.beans.BeanWrapperImpl} will
 * register this editor by default.
 *
 * <p>
 * Also supports conversion from a Unicode character sequence; e.g. {@code u0041} ('A').
 *
...
public class CharacterEditor extends PropertyEditorSupport {
	 ...
	 * <p>
	 * The "allowEmpty" parameter controls whether an empty String is to be allowed in
	 * parsing, i.e. be interpreted as the {@code null} value when
