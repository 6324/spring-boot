...
/**
 * {@link EntityResolver} implementation that attempts to resolve schema URLs into local
 * {@link ClassPathResource classpath resources} using a set of mappings files.
 *
 * <p>
 * By default, this class will look for mapping files in the classpath using the pattern:
 * {@code META-INF/spring.schemas} allowing for multiple files to exist on the classpath
 * at any one time.
 *
 * <p>
...
public class PluggableSchemaResolver implements EntityResolver {
	...
	/**
	 * The location of the file that defines schema mappings. Can be present in multiple
	 * JAR files.
	 */
	...
	/**
	 * Loads the schema URL -> schema file location mappings using the default mapping
	 * file pattern "META-INF/spring.schemas".
	...
	/**
	 * Loads the schema URL -> schema file location mappings using the given mapping file
	 * pattern.
	 * @param classLoader the ClassLoader to use for loading (can be {@code null}) to use
	 * the default ClassLoader)
