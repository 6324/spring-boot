...
/**
 * The default implementation of the {@link PropertyValues} interface. Allows simple
 * manipulation of properties, and provides constructors to support deep copy and
...
public class MutablePropertyValues implements PropertyValues, Serializable {
	...
	/**
	 * Construct a new MutablePropertyValues object using the given List of PropertyValue
	 * objects as-is.
	 * <p>
	 * This is a constructor for advanced usage scenarios. It is not intended for typical
	 * programmatic use.
	...
	/**
	 * Return the underlying List of PropertyValue objects in its raw form. The returned
	 * List can be modified directly, although this is not recommended.
	 * <p>
	 * This is an accessor for optimized access to all PropertyValue objects. It is not
	 * intended for typical programmatic use.
	 */
	...
	/**
	 * Copy all given PropertyValues into this object. Guarantees PropertyValue references
	 * are independent, although it can't deep copy objects currently referenced by
	 * individual PropertyValue objects.
	 ...
	 * @param other a Map with property values keyed by property name, which must be a
	 * String
	 * @return this in order to allow for adding multiple property values in a chain
	 */
	...
	/**
	 * Overloaded version of {@code addPropertyValue} that takes a property name and a
	 * property value.
	 * <p>
	 * Note: As of Spring 3.0, we recommend using the more concise and chaining-capable
	 * variant {@link #add}.
	 ...
	 * calling the corresponding setter method outside of the PropertyValue(s) mechanism.
	 * <p>
	 * This will lead to {@code true} being returned from a {@link #contains} call for the
	 * specified property.
	...
	/**
	 * Mark this holder as containing converted values only (i.e. no runtime resolution
	 * needed anymore).
	 */
