...
/**
 * Strategy interface to be implemented by objects than can resolve bean name information,
 * given a newly instantiated bean object. Invocations to the {@link #resolveWiringInfo}
 * method on this interface will be driven by the AspectJ pointcut in the relevant
 * concrete aspect.
 *
 * <p>
 * Metadata resolution strategy can be pluggable. A good default is
 * {@link ClassNameBeanWiringInfoResolver}, which uses the fully-qualified class name as
 * bean name.
 *
 * @author Rod Johnson
 * @since 2.0
