 ...
 * {@link org.springframework.transaction.PlatformTransactionManager} implementations. It
 * is mainly provided as a start for custom transaction manager implementations and as a
 * static mock for testing transactional code (either as part of a mock
 * {@code PlatformTransactionManager} or as argument passed into a
 * {@link TransactionCallback} to be tested).
 *
...
public class SimpleTransactionStatus extends AbstractTransactionStatus {
	...
	/**
	 * Create a new {@code SimpleTransactionStatus} instance, indicating a new
	 * transaction.
	 */
