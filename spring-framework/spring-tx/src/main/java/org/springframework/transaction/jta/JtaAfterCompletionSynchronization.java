 ...
 * {@code afterCompletion} callbacks of Spring {@link TransactionSynchronization} objects
 * callbacks after the outer JTA transaction has completed. Applied when participating in
 * an existing (non-Spring) JTA transaction.
 *
...
public class JtaAfterCompletionSynchronization implements Synchronization {
	...
	/**
	 * Create a new JtaAfterCompletionSynchronization for the given synchronization
	 * objects.
