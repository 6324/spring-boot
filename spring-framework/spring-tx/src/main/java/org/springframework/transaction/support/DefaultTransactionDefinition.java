...
/**
 * Default implementation of the {@link TransactionDefinition} interface, offering
 * bean-style configuration and sensible default values (PROPAGATION_REQUIRED,
 * ISOLATION_DEFAULT, TIMEOUT_DEFAULT, readOnly=false).
 *
 * <p>
...
public class DefaultTransactionDefinition implements TransactionDefinition, Serializable {
	...
	/**
	 * Create a new DefaultTransactionDefinition, with default settings. Can be modified
	...
	/**
	 * Create a new DefaultTransactionDefinition with the given propagation behavior. Can
	 ...
	 * the {@code PROPAGATION_} constants or is {@code null}
	 * @see #setPropagationBehavior
	 ...
	 * level.
	 * <p>
	 * Note that a transaction manager that does not support custom isolation levels will
	 * throw an exception when given any other level than {@link #ISOLATION_DEFAULT}.
	 ...
	 * @param constantName name of the constant
	 * @throws IllegalArgumentException if the supplied value is not resolvable to one of
	 * the {@code ISOLATION_} constants or is {@code null}
	 * @see #setIsolationLevel
	 ...
	 * <p>
	 * This will be used as transaction name to be shown in a transaction monitor, if
	 ...
	 * {@link org.springframework.transaction.interceptor.TransactionAttributeEditor}, to
	 * be able to feed {@code toString} results into bean properties of type
	 * {@link org.springframework.transaction.interceptor.TransactionAttribute}.
	 * <p>
	 * Has to be overridden in subclasses for correct {@code equals} and {@code hashCode}
	 * behavior. Alternatively, {@link #equals} and {@link #hashCode} can be overridden
	 * themselves.
