...
/**
 * A {@link FactoryBean} equivalent to the &lt;tx:jta-transaction-manager/&gt; XML
 * element, autodetecting WebLogic and WebSphere servers and exposing the corresponding
