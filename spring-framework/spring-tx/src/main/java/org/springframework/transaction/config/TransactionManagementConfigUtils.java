...
public abstract class TransactionManagementConfigUtils {
	...
	/**
	 * The bean name of the internally managed transaction advisor (used when mode ==
	 * PROXY).
	 */
	...
	/**
	 * The bean name of the internally managed transaction aspect (used when mode ==
	 * ASPECTJ).
	 */
	...
	/**
	 * The bean name of the internally managed JTA transaction aspect (used when mode ==
	 * ASPECTJ).
	 * @since 5.1
	 */
	...
	/**
	 * The name of the AspectJ transaction management @{@code Configuration} class for
	 * JTA.
	 * @since 5.1
	 */
