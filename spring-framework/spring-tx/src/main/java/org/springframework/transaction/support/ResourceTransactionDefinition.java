...
public interface ResourceTransactionDefinition extends TransactionDefinition {
	 ...
	 * @return {@code true} if the resource is known to be entirely transaction-local, not
	 * affecting any operations outside of the scope of the current transaction
	 * @see #isReadOnly()
	 */
