...
/**
 * Interface specifying basic transaction execution operations. Implemented by
 * {@link TransactionTemplate}. Not often used directly, but a useful option to enhance
...
public interface TransactionOperations {
	 ...
	 * <p>
	 * This variant is analogous to using a {@link TransactionCallbackWithoutResult} but
	 * with a simplified signature for common cases - and conveniently usable with Java 8
	 * lambda expressions.
	 ...
	 * <p>
	 * Useful for testing: The behavior is equivalent to running with a transaction
	 * manager with no actual transaction (PROPAGATION_SUPPORTS) and no synchronization
	 * (SYNCHRONIZATION_NEVER).
	 * <p>
	 * For a {@link TransactionOperations} implementation with actual transaction
	 * processing, use {@link TransactionTemplate} with an appropriate
