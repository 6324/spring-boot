 ...
 *
 * <p>
 * Implementors of this interface automatically express a preference for callbacks over
 * programmatic {@code getTransaction}, {@code commit} and {@code rollback} calls. Calling
 * code may check whether a given transaction manager implements this interface to choose
 * to prepare a callback instead of explicit transaction demarcation control.
 *
 * <p>
 * Spring's {@link TransactionTemplate} and
 * {@link org.springframework.transaction.interceptor.TransactionInterceptor} detect and
 * use this PlatformTransactionManager variant automatically.
 *
