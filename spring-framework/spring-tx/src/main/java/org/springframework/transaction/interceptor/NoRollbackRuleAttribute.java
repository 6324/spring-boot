...
/**
 * Tag subclass of {@link RollbackRuleAttribute} that has the opposite behavior to the
 * {@code RollbackRuleAttribute} superclass.
 *
 * @author Rod Johnson
 * @since 09.04.2003
 */
...
public class NoRollbackRuleAttribute extends RollbackRuleAttribute {
	...
	/**
	 * Create a new instance of the {@code NoRollbackRuleAttribute} class for the supplied
