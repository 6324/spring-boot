...
/**
 * Miscellaneous utility methods for DAO implementations. Useful with any data access
 * technology.
 *
...
public abstract class DataAccessUtils {
	 ...
	 * <p>
	 * Returns {@code null} if 0 result objects found; throws an exception if more than 1
	 * element found.
	 * @param results the result Collection (can be {@code null})
	 * @return the single result object, or {@code null} if none
	 * @throws IncorrectResultSizeDataAccessException if more than one element has been
	 ...
	 * @param results the result Collection (can be {@code null} but is not expected to
	 * contain {@code null} elements)
	 * @return the single result object
	 * @throws IncorrectResultSizeDataAccessException if more than one element has been
	 * found in the given Collection
	 * @throws EmptyResultDataAccessException if no element at all has been found in the
	 * given Collection
	 */
	 ...
	 * <p>
	 * Throws an exception if 0 or more than 1 element found.
	 * @param results the result Collection (can be {@code null} and is also expected to
	 * contain {@code null} elements)
	 * @return the single result object
	 * @throws IncorrectResultSizeDataAccessException if more than one element has been
	 * found in the given Collection
	...
	public static <T> T nullableSingleResult(@Nullable Collection<T> results)
		...
		// semantics of the incoming Collection (which we currently can't formally
		// express)
		if (CollectionUtils.isEmpty(results)) {
			throw new EmptyResultDataAccessException(1);
		}
	 ...
	 * @throws IncorrectResultSizeDataAccessException if more than one result object has
	 ...
	 * @throws IncorrectResultSizeDataAccessException if more than one result object has
	 * been found in the given Collection
	 * @throws EmptyResultDataAccessException if no result object at all has been found in
	...
	/**
	 * Return a unique result object from the given Collection. Throws an exception if 0
	 * or more than 1 result objects found, of if the unique result object is not
	 * convertible to the specified required type.
	 * @param results the result Collection (can be {@code null} but is not expected to
	 * contain {@code null} elements)
	 * @return the unique result object
	 * @throws IncorrectResultSizeDataAccessException if more than one result object has
	 ...
	 * @throws EmptyResultDataAccessException if no result object at all has been found in
	 * the given Collection
	 * @throws TypeMismatchDataAccessException if the unique object does not match the
	...
	public static <T> T objectResult(@Nullable Collection<?> results, @Nullable Class<T> requiredType)
		...
		if (requiredType != null && !requiredType.isInstance(result)) {
			if (String.class == requiredType) {
				...
				try {
					result = NumberUtils.convertNumberToTargetClass(((Number) result),
				...
				throw new TypeMismatchDataAccessException("Result object is of type [" + result.getClass().getName()
	...
	/**
	 * Return a unique int result from the given Collection. Throws an exception if 0 or
	 * more than 1 result objects found, of if the unique result object is not convertible
	 * to an int.
	 * @param results the result Collection (can be {@code null} but is not expected to
	 * contain {@code null} elements)
	 ...
	 * @throws EmptyResultDataAccessException if no result object at all has been found in
	 * the given Collection
	 * @throws TypeMismatchDataAccessException if the unique object in the collection is
	...
	/**
	 * Return a unique long result from the given Collection. Throws an exception if 0 or
	 * more than 1 result objects found, of if the unique result object is not convertible
	 * to a long.
	 * @param results the result Collection (can be {@code null} but is not expected to
	 * contain {@code null} elements)
	...
	/**
	 * Return a translated exception if this is appropriate, otherwise return the given
	 * exception as-is.
	 ...
	 * @return a translated persistence exception if translation is possible, or the raw
