 ...
 * J2EE Design and Development</a>. Please see Chapter 9 of this book for detailed
 ...
 * encountered without knowing the details of the particular data access API in use (e.g.
 * JDBC). Thus it is possible to react to an optimistic locking failure without knowing
 * that JDBC is being used.
 *
 * <p>
