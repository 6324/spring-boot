...
/**
 * {@link org.springframework.context.ApplicationContext} implementation for a JCA
 * ResourceAdapter. Needs to be initialized with the JCA
 * {@link javax.resource.spi.BootstrapContext}, passing it on to Spring-managed beans that
 * implement {@link BootstrapContextAware}.
 *
...
public class ResourceAdapterApplicationContext extends GenericApplicationContext {
	 ...
	 * @param bootstrapContext the JCA BootstrapContext that the ResourceAdapter has been
	 * started with
	 */
