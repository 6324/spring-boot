 ...
 * candidate (usually fully qualified name) and the stereotypes are "markers" that can be
 * used to retrieve the candidates. A typical use case is the presence of a given
