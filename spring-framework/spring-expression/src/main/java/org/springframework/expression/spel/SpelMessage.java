 ...
 *
 * <p>
 * When a message is formatted, it will have this kind of form, capturing the prefix and
 * the error kind:
 *
...
public enum SpelMessage {
	...
	FUNCTION_MUST_BE_STATIC(Kind.ERROR, 1039, "Only static methods can be called via function references. "
	...
	/**
	 * Produce a complete message including the prefix and with the inserts applied to the
	 * message.
