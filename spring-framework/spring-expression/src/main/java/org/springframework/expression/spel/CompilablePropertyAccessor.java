...
/**
 * A compilable property accessor is able to generate bytecode that represents the access
 * operation, facilitating compilation to bytecode of expressions that use the accessor.
 *
 * @author Andy Clement
 * @since 4.1
 */
public interface CompilablePropertyAccessor extends PropertyAccessor, Opcodes {
	...
	/**
	 * Return {@code true} if this property accessor is currently suitable for
	 * compilation.
	 */
	boolean isCompilable();

	/**
	 * Return the type of the accessed property - may only be known once an access has
	 * occurred.
	 */
