...
public interface HandshakeHandler {
	 ...
	 * {@link PerConnectionWebSocketHandler} for providing a handler with per-connection
	 * lifecycle.
	 ...
	 * response status, headers, and body will have been updated to reflect the result of
	 * the negotiation
	 ...
	 * a failure to successfully negotiate the handshake.
	 */
