...
public class SockJsServiceRegistration {
	 ...
	 * "https://cdn.jsdelivr.net/sockjs/0.3.4/sockjs.min.js". However it can also be set
	 ...
	 * while. This property sets a minimum number of bytes that can be send over a single
	 ...
	 * after which the server should send a heartbeat frame to the client in order to keep
	...
	/**
	 * Some load balancers don't support WebSocket. This option can be used to disable the
	 * WebSocket transport on the server side.
	 * <p>
	 ...
	 * <p>
	 * By default {@code Jackson2SockJsMessageCodec} is used requiring the Jackson library
