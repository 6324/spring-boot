...
public interface WebSocketMessageBrokerConfigurer {
	 ...
	 * incoming messages from WebSocket clients. By default the channel is backed by a
	 * thread pool of size 1. It is recommended to customize thread pool settings for
	 * production use.
	 */
	 ...
	 * {@code SimpAnnotationMethodMessageHandler} directly.
	 ...
	 * annotated methods and when sending messages (e.g. through the "broker"
	 * SimpMessagingTemplate).
	 * <p>
	 * The provided list, initially empty, can be used to add message converters while the
	 * boolean return value is used to determine if default message should be added as
	 * well.
