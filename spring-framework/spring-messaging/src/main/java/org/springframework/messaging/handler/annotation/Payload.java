...
/**
 * Annotation that binds a method parameter to the payload of a message. Can also be used
 * to associate a payload to a method invocation. The payload may be passed through a
 * {@link MessageConverter} to convert it from serialized form with a specific MIME type
 * to an Object matching the target method parameter.
 *
