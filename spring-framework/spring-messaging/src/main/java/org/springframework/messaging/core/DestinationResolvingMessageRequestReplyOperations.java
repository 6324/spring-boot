...
public interface DestinationResolvingMessageRequestReplyOperations<D> extends MessageRequestReplyOperations<D> {
	...
	/**
	 * Resolve the given destination name, convert the payload request Object to
	 * serialized form, possibly using a
	 * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a
	 * message and send it to the resolved destination, receive a reply and convert its
	 ...
	 * serialized form, possibly using a
	 * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a
	 * message with the given headers and send it to the resolved destination, receive a
	 * reply and convert its body to the specified target class.
	 * @param destinationName the name of the target destination
	 * @param request the payload for the request message to send
	 ...
	 * serialized form, possibly using a
	 * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a
	 * message, apply the given post process, and send the resulting message to the
	 * resolved destination, then receive a reply and convert its body to the specified
	 * target class.
	 * @param destinationName the name of the target destination
	 * @param request the payload for the request message to send
	 * @param targetClass the target class to convert the payload of the reply to
	 ...
	 * serialized form, possibly using a
	 * {@link org.springframework.messaging.converter.MessageConverter}, wrap it as a
	 * message with the given headers, apply the given post process, and send the
	 * resulting message to the resolved destination, then receive a reply and convert its
	 * body to the specified target class.
	 * @param destinationName the name of the target destination
	 * @param request the payload for the request message to send
	 * @param headers the headers for the request message to send
