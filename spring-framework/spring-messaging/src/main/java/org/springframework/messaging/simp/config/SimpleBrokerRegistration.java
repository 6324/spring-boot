...
public class SimpleBrokerRegistration extends AbstractBrokerRegistration {
	 ...
	 */
	public SimpleBrokerRegistration(SubscribableChannel clientInboundChannel, MessageChannel clientOutboundChannel,
	...
	/**
	 * Configure the value for the heartbeat settings. The first number represents how
