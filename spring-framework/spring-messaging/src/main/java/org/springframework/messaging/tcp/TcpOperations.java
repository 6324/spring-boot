...
public interface TcpOperations<P> {
	 ...
	 * @return a ListenableFuture that can be used to determine when and if the connection
	 ...
	 * @return a ListenableFuture that can be used to determine when and if the initial
