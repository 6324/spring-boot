 ...
 *
 * <p>
 * In case of a conversion hint being provided, the framework will call these extended
 * methods if a converter implements this interface, instead of calling the regular
 * {@code fromMessage} / {@code toMessage} variants.
 *
...
public interface SmartMessageConverter extends MessageConverter {
	...
	/**
	 * A variant of {@link #fromMessage(Message, Class)} which takes an extra conversion
	 ...
	 * conversion context as an argument, allowing to take e.g. annotations on a return
	 * type into account.
