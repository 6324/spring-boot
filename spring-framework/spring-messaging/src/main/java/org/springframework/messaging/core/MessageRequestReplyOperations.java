...
public interface MessageRequestReplyOperations<D> {
	 ...
	 * {@link Message} to a default destination, receive the reply and convert its body of
	 ...
	 * post processor and send the resulting {@link Message} to a default destination,
